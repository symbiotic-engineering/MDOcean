...
[B,FOS1Y,FOS2Y,FOS3Y,FOS_buckling] = structures(V_d,V_s, m_tot, F_hydro_heave, F_surge, F_ptrain, x.M, h, p.rho_w, p.g, p.sigma_y, A_c, A_lat_sub, r_over_t, I, p.E);

[LCOE, Lt] = econ(m_tot, V_m, x.M, p.cost_m, x.N_WEC, p.i_PT, p.d_shore, FOS, P_elec,p.FCR);	
end