...
While the first three methods take \gradientSensRuntime~to run, the fourth method takes \reoptimSensRuntime, since \resultsRE[numReoptims]~separate optimizations are performed.
