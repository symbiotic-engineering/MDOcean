...
\begin{table}
    ...
    \end{tabular}
    \caption{Legend keys for the dynamics and controls columns of table~\ref{remdo:tab:lit}}
...
& Irregular wave spectrum\\
    ...
    \end{tabular}
    \caption{Legend keys for other modeling columns of table~\ref{remdo:tab:lit}}
...
& Altair Inspire (commercial tool)& LO& Loads (force, force per size)& STR& Structural failure& SHP&Hull shape\\
 BF& Brute force sweep& BW& Bandwidth& PWR& Minimum power& &\\
    \end{tabular}
    \caption{Legend keys for the optimization columns of table~\ref{remdo:tab:lit}}
