...
\begin{figure}
\centering
\includegraphics[width=\linewidth]{../renewable-energy-mdo/figs/from-matlab/single_obj_convergence.pdf}
...
\begin{figure}
\centering
\includegraphics[width=1.2\linewidth]{../renewable-energy-mdo/figs/from-matlab/multistart_parallel_coordinates.pdf}
...
\begin{figure}
\includegraphics[width=\linewidth]{../renewable-energy-mdo/figs/from-matlab/post_optim_re_optim_objective_grid.pdf}
...
\begin{figure}
\includegraphics[width=\linewidth]{../renewable-energy-mdo/figs/from-matlab/post_optim_design_grid.pdf}
\caption{Quadratic parameter sensitivity analysis to optimal design $x^*$}
\label{fig:param-sens-local-x-star}
\end{figure}

\begin{figure}
\includegraphics[width=\linewidth]{../renewable-energy-mdo/figs/from-matlab/re_optim_design_grid.pdf}
