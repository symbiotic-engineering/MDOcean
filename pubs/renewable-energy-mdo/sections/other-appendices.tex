...
\Cref{remdo:fig:param-sens-local-global-J-star} together with \cref{remdo:fig:param-sens-local-x-star} and \cref{remdo:fig:param-sens-global-x-star} depict the local sensitivities of the optimal objective and optimal design variables, respectively, to parameters. 
\begin{figure}[htbp]
