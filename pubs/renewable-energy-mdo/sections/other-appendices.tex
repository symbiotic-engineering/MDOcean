...
\begin{tabular}{>{\centering\arraybackslash}p{0.04\linewidth}L{0.14\linewidth}|>{\centering\arraybackslash}p{0.04\linewidth}L{0.14\linewidth}|>{\centering\arraybackslash}p{0.04\linewidth}L{0.14\linewidth}|>{\centering\arraybackslash}p{0.04\linewidth}L{0.14\linewidth}|>{\centering\arraybackslash}p{0.04\linewidth}L{0.14\linewidth}}
...
\begin{tabular}{>{\centering\arraybackslash}p{0.04\linewidth}L{0.18\linewidth}|>{\centering\arraybackslash}p{0.04\linewidth}L{0.18\linewidth}|>{\centering\arraybackslash}p{0.04\linewidth}L{0.18\linewidth}|>{\centering\arraybackslash}p{0.04\linewidth}L{0.18\linewidth}}
