...
\end{equation}
The forms of the parameter-agnostic $A_{sens}$ matrix and the parameter-specific $b_{sens}$ vector are given in reference \cite{sobieszczanski-sobieski_sensitivity_1982} and not repeated here.
...
\Cref{remdo:fig:param-sens-local-x-star} and \cref{remdo:fig:param-sens-global-x-star} depict the normalized local parameter sensitivities of the optimal design.
