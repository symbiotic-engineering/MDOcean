...
\else
    ...
    Its MATLAB implementation keeps every intermediate query within bounds, helping maintain the model validity required by the priority 1 requirements of \cref{remdo:sec:requirements}.
