...
\ifdefined\DISSERTATION
    ...
    Two recent papers introduce derivatives for BEM hydrodynamics packages \citep{rohrer_analytical_2024,khanal_fully_2025}, the former reviewing other work on hydrodynamic gradients.
...
\ifdefined\DISSERTATION
    ...
    The MATLAB \texttt{paretosearch} function then executes the constrained multi-objective pattern search of \citep{custodio_direct_2011}, starting from the SQP-optimized epsilon-constraint points and maximizing Pareto hypervolume and spread to quickly fill gaps between them.
\else
