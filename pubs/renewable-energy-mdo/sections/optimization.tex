...
%%%
This subsection defines the single-objective optimization setup, including algorithm choice, derivatives, and scaling.
\paragraph{Algorithm}
...
\else
    ...
    This study therefore uses finite difference, viable given the cheap simulation; initial concerns about oscillatory hydrodynamics \cite{mccabe_open-source_2024} proved unfounded, as the overall coefficients are far less oscillatory than their subfunctions.
