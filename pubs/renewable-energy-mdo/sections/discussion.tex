%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Implications for future optimization formulations}\label{remdo:sec:discussion}

\ifdefined\DISSERTATION
    Building on the analysis in \Cref{remdo:sec:results}, this subsection discusses the study's contributions, implications, and limitations more broadly.
...
\else
    Building on the per-result analysis of \Cref{remdo:sec:results}, this subsection discusses contributions and limitations, compares with existing studies, and suggests future work.
\fi

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{Result Comparison to Other Studies }
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{Formulation Realism}
