% MEGHANA do ctrl+F for \hl{} to find highlighted bits in this file.
...
\ifdefined\DISSERTATION
    (see \Cref{aor:sec:appendix-slamming})
...
An examination of Lagrange multipliers (see \Cref{fig:re:constraint-activity}) confirms that operational fatigue constraints are active while storm constraints are inactive.
...
\ifdefined\DISSERTATION
    ...
    See \Cref{aor:sec:power-matrix-mult} for the definitions of each quantity.
