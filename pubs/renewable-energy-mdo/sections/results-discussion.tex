...
\ifdefined\DISSERTATION
    ...
    The Pareto front is shown in \Cref{remdo:fig:pareto}, with the utopia point marked by a green star, simulated designs by squares, and the actual nominal performance reported in the RM3 reference \citep{RM3} by a diamond.
    All Pareto-optimal designs cost significantly less than the nominal RM3, spanning powers both below and above it.
    \Cref{remdo:fig:pareto-lcoe} provides a zoomed view with superimposed constant-$LCOE$ contours.
