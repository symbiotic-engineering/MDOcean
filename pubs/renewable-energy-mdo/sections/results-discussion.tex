...
There is a divide between the west coast and Hawaii, and it's more predictive to look at how energetic the waves are (calmer waves means you need a bigger device), and less predictive to look at the frequency of the waves (higher frequency means you need a smaller device).
...
\paragraph{Power Production and Financing are Important at Grid Scale}
\ifdefined\DISSERTATION
...
This insight for min-LCOE confirms what we already knew, that power and financing are important for grid scale.
