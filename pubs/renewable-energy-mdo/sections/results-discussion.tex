...
\ifdefined\DISSERTATION
    ...
    MDOcean's 2-DOF dynamics run roughly an order of magnitude slower than its 1-DOF dynamics \citep{mccabe_development_2026}, suggesting that code improvements to narrow this gap may be worthwhile given the dynamic importance of the second degree of freedom.
...
\else
    ...
    The 2-DOF dynamics run roughly an order of magnitude slower than 1-DOF \citep{mccabe_development_2026}, suggesting worthwhile code improvements, while force saturation reduces both powertrain cost and, via lower heave loading, structural cost.
