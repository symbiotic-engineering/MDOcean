...
\ifdefined\DISSERTATION
    ...
    and its estimated LCOE is \resultsRE[minLCOE]~\$/kWh under the economic assumptions of \citet{mccabe_development_2026}.
...
\else
    ...
    The Pareto front (\Cref{remdo:fig:pareto}) shows all designs costing significantly less than the nominal RM3 \citep{RM3} across a range of powers;
