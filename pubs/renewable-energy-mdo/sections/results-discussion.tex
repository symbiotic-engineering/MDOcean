...
\else
    ...
    The most transformative additions, such as irregular waves (enabling realistic fatigue and power-variability studies), additional \gls{acr-wec} archetypes (addressing design convergence), multi-region MEEM hydrodynamics, and a generator physics model (enabling generator control co-design, as in \citet{anderson_re-imagining_2024,barter_beyond_2023}), would unlock qualitatively new design studies.
