...
\ifdefined\DISSERTATION
    ...
    Nonzero multiplier values are reported in \Cref{remdo:fig:lagrange-multiplier}, each signifying the increase in objective $\gls{sym-J}$ per unit increase in an active constraint $\gls{sym-g}$.
\else
