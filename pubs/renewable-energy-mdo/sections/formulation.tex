...
\ifdefined\DISSERTATION
    For example, bulk dimensions hvm could be encoded directly as dimensions $T_{f,2}$ and $T_s$, or nondimensionally as dimension $T_s$ and ratio $T_{f,2}/T_s$.
    An encoding may be chosen because it more directly controls the objective, makes the problem convex in the obj or constraints, or helps maintain feasibility and convergence during optimization. The last is pursued here.
