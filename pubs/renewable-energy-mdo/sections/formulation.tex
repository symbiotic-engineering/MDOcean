...
\singleColMacro{
  ...
  \requirement{float_stiffener_height}& $h_{\text{stiff},f} < \gls{sym-h-f} / 2$& Maximum float stiffener height& 3 &Lin. ineq. constraint $g_{L,8}$\\
  ...
  \requirement{force_max}&$\gls{sym-F-p} = F_{\text{max}}$& Maximum powertrain force& 3&Nonlin. ineq. constraint $g_{NL,16}-g_{NL,17}$\\
  \requirement{P_max}&$\gls{sym-P-pk-elec} = P_{\text{max}}$& Maximum powertrain power& 3&Nonlin. ineq. constraint $g_{NL,18}$\\
...
\begin{tabular}{c>{\centering\arraybackslash}m{0.12\linewidth}>{\centering\arraybackslash}m{0.25\linewidth}>{\centering\arraybackslash}m{0.12\linewidth}>{\centering\arraybackslash}m{0.12\linewidth}>{\centering\arraybackslash}m{0.12\linewidth}c}
 ...
 $x_{7}$&$\gls{sym-P-pk-elec}$& Generator peak power rating & 50& 286& 1000& kW\\
