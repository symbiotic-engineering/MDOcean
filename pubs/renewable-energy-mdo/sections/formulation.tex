...
\newcounter{reqnumber}
\singleColMacro{
    \begin{longtable}{c>{\centering\arraybackslash}p{0.25\linewidth}>{\centering\arraybackslash}p{0.27\linewidth}>{\centering\arraybackslash}p{0.08\linewidth}L{0.28\linewidth}}
