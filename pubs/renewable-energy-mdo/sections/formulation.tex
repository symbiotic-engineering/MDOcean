...
\singleColMacro{
  ...
  \hline 
  \requirement{float_base_diameter}& $D_{f,in} <\gls{sym-D-f-b} < D_f$& Float base diameter& 2&Parameter $\gls{sym-D-f-b}/D_f$ \\
...
\ifdefined\DISSERTATION
    For example, the float spar and drafts could be encoded directly as dimensions $T_{f,2}$ and $T_s$, or nondimensionally as dimension $T_s$ and ratio $T_{f,2}/T_s$.
