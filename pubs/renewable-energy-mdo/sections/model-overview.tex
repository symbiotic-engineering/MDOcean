...
The extended design structure matrix (XDSM) diagram in Figure \ref{remdo:fig:n2} illustrates the functional interfaces between modules.
...
Each of these four control architectures can coexist with both MDF and SAND analysis architectures, shown in Figure~\ref{remdo:fig:control-arch}.
