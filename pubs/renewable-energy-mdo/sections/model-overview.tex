...
\begin{figure}
\centering
\includegraphics[width=\linewidth]{../renewable-energy-mdo/figs/from-matlab/xdsm.pdf}
...
Implicit-MDF is chosen over explicit-MDF because the available optimal control condition is implicit, as \cref{sec:model} will detail.

\begin{figure}
\centering
\includegraphics[width=1.1\linewidth]{../renewable-energy-mdo/figs/from-matlab/control_analysis_flowcharts.pdf}
