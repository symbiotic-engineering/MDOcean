...
This is a \pctImproveLCOEMinLCOE~LCOE improvement over the nominal design's \results[nominalLCOE], created through a simultaneous \pctImproveDesignCostMinLCOE~reduction in design-dependent cost and an \pctImprovePowerMinLCOE~increase in average power.
