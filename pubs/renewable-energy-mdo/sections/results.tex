...
The hydrodynamic coefficients and power distributions of each single-objective optimal design, with the nominal for reference, are compared in \cref{remdo:fig:overlaid-hydro} and \cref{remdo:fig:overlaid-power-dist}, with numerical results in \cref{remdo:tab:opt-output}.
