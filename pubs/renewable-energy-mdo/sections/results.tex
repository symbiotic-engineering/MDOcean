...
\hl{Note to scrutineers: all results shown are for pure-damping control, except} figure \ref{fig:pareto-control-compare}.
\hl{I am still generating the results for reactive control and will include them when they are ready.}
...
The latter is a $CAPEX$ minimization run with an additional constraint that the average power must exceed \resultsRE[powerBalanced]~kW, a number chosen based on the shape of the multi-objective pareto front that will be presented in section \ref{sec:results-multi} with the intent of obtaining a cost reduction at the expense of a small power reduction compared to the minimum LCOE design.
...
\begin{figure}
\centering
\includegraphics[width=\linewidth]{../renewable-energy-mdo/figs/from-matlab/experiments_ratios.pdf}
\caption{Geometries overlaid}
\label{fig:overlaid-geometry}
\end{figure}

\begin{table}
\input{ ../renewable-energy-mdo/tables/from-matlab/optimal_design_vars.tex }
...
\begin{figure}
\centering
\includegraphics[width=\linewidth]{../renewable-energy-mdo/figs/from-matlab/overlaid_hydro_coeffs.pdf}
\caption{Hydrodynamic coefficients overlaid}
\label{fig:overlaid-hydro}
\end{figure}
\begin{figure}
\centering
\includegraphics[width=\linewidth]{../renewable-energy-mdo/figs/from-matlab/probability_CDF.pdf}
...
\begin{table}
\input{ ../renewable-energy-mdo/tables/from-matlab/optimal_outputs.tex }
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{../renewable-energy-mdo/figs/from-matlab/single_obj_opt_power_matrix.pdf}
...
\begin{figure}
\centering
\includegraphics[width=1\linewidth]{../renewable-energy-mdo/figs/from-matlab/lagrange_multipliers.pdf}
...
\begin{figure}
\centering
\includegraphics[width=\linewidth]{../renewable-energy-mdo/figs/from-matlab/delta_x.pdf}
...
Notably, all values are nonzero, indicating that all design variables in some way affect the active constraints identified in \ref{fig:lagrange-multiplier}.
...
\begin{figure}
    \centering
    \includegraphics[width=1.2\linewidth]{../renewable-energy-mdo/figs/from-matlab/multistart_convergence_tree.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{../renewable-energy-mdo/figs/from-matlab/re_optim_objective_tornado.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{../renewable-energy-mdo/figs/from-matlab/re_optim_design_tornado_J1.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{../renewable-energy-mdo/figs/from-matlab/re_optim_design_tornado_J2.pdf}
...
\input{../renewable-energy-mdo/tables/location_table.tex}
...
First examining the optimal LCOE design presented in \sectionautorefname~\ref{sec:results-single}, the lowest force saturation power factor across all sea states in \figureautorefname~\ref{fig:power-matrix-opt} is $\frac{P_{sat}}{P_{unsat}}=\resultsRE[lowestFmaxFactorMinLCOE]$, with a corresponding force limit of $\frac{F_{max}}{F_{unsat}}=\lowestFsatMinLCOE$~in that sea state. 
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{../renewable-energy-mdo/figs/from-matlab/pareto_front_with_design_images.pdf}
    \caption{Pareto Front}
    \label{fig:pareto}
\end{figure}
\begin{figure}
\centering
\includegraphics[width=.8\linewidth]{../renewable-energy-mdo/figs/from-matlab/pareto_front_LCOE_contours.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{../renewable-energy-mdo/figs/from-matlab/pareto_heuristics.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{../renewable-energy-mdo/figs/from-matlab/pareto_constraint_activity_reactive.pdf}
...
\paragraph{Control Scheme}
Figure~\ref{fig:pareto-lcoe} compares the pareto front for the damping control scheme to the reactive control scheme.
...
\begin{figure}
\centering
\includegraphics[width=\linewidth]{../renewable-energy-mdo/figs/from-matlab/runtime_bar_chart.pdf}
