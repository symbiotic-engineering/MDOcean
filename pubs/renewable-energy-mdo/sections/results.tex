...
This section presents optimization outcomes, targeted sensitivity analyses, and the corresponding discussion of formulation and model assumptions.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Sensitivity to Prioritize Disciplinary R\&D}\label{remdo:sec:sensitivities}
This subsection quantifies how parameter and model-assumption changes affect optimized designs and objectives to help prioritize disciplinary R\&D.
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\linewidth]{example-image-a}
    \caption{econ sensitivity contour plot}
    \label{remdo:fig:econ-sensitivity-contour-placeholder}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=\linewidth]{example-image-a}
    \caption{post hoc nwec sweep}
    \label{remdo:fig:post-hoc-nwec-sweep-placeholder}
\end{figure}
