...
\begin{figure}
\centering
\includegraphics[width=\linewidth]{figs/from-matlab/experiments.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{figs/from-matlab/pareto_constraint_activity.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=.8\linewidth]{figs/manual/damping_reactive_pareto.png}
    \caption{Pareto Front comparison for Damping vs Reactive Control}
    \label{fig:pareto-control-compare}
\end{figure}
\hl{Add explanation and debug why reactive control stops at 120 kW.}
