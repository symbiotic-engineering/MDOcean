...
\ifdefined\DISSERTATION
    ...
    \citet{mcgilton_optimal_2024} reports only 3\% energy loss from a 70\% force-rating reduction across multiple device archetypes (RM3, RM5), sites, and scales, supporting analytical predictions in \citep{coe_maybe_2021,devin_high-dimensional_2024}.
    ...
    Structural optimization faces a parallel compute bottleneck, with FEA-based optimization usually replaced by manual iteration \cite{RM3,mi_multi-scale_2025}, commercial decoupled tools \cite{an_optimal_2024}, brute-force sweeps over analytical stress \cite{ambuhl_reliability-based_2014}, or load-magnitude proxies \citep{nguyen_theoretical_2024,ferri_balancing_2014}.
