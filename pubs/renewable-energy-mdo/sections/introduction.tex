...
The remainder of the introduction reviews \gls{acr-wec} optimization literature, frames the research gap, articulates the case for multidisciplinary design optimization, and identifies the paper's contributions and structure.
...
\ifdefined\DISSERTATION
    ...
    The control co-design literature \citep{garcia-sanz_control_2019,coe_useful_2023} has produced joint PTO-and-controller optimizations
...
\ifdefined\DISSERTATION
    ...
    Despite recognized need and growing interest in concurrent design and control co-design for \glspl{acr-wec} \citep{mi_multi-scale_2025,ringwood_empowering_2023}, MDO has not yet caught on in the wave energy space, preventing potential techno-economic breakthroughs.
