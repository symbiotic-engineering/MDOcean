...
\else
    ...
    Dynamic modeling is typically performed in either the frequency or time domain, sometimes with constraint-handling extensions (F+) or pseudo-spectral (PS) variants.
    Mooring, powertrain, structural, and economic disciplines are included inconsistently across studies.
    Common optimization methods include genetic algorithms (GA), local optimizers (LOC), Pontryagin’s maximum principle (PMP), and design-of-experiment or brute-force approaches.
...
\citet{mccabe_multidisciplinary_2022} & 2-PA & ALG & - & 1 & F+ & PI+ & - & EFF & AN & STR & REG+, STO
& LOC & ECON, VAR & GEO, PTO & DIM, PTO & 7 \\

\citet{khanal_multi-objective_2024} & 1-PA array & BEM & - & 4 & F & PI+ & - & - & - & GEO & REG
& GA & ECON, ARRY & GEO, PTO & DIM, CTL & 14 \\

\citet{gaudin_single_2021} & 1-PA array & MEEM & - & 120 & F & PI & DES & - & AN & MOOR & IRR+, STO & GA & PWR, ECON & GEO, STR & DIM, CTL & 4 \\

\citet{edwards_optimisation_2022} & 1-PA & BEM & - & 1 & F & P & - & - & - & GEO & REG
& GA & ECON & AMP, GEO, PWR, STA & DIM, SHP & 15 \\

\citet{garcia-teruel_reliability-based_2021}& 1-PA & BEM & LD & 1 & F+ & PI & - & - & LD & - & IRR+
& GA & PWR, LD & AMP, PTO & DIM, SHP & 66 \\

\citet{garcia-teruel_design_2022}& 1-PA & BEM & - & 2 & F+ & PI & - & - & - & - & IRR
& GA & ECON, PWR & AMP, PTO & DIM, SHP & 4 \\

\citet{cotten_multi-objective_2022} & ATN & BEM & - & 10 & F+ & P & - & - & LD & - & IRR+
& GA & ECON, LD & GEO, STA & DIM & 8 \\

\citet{abdulkadir_control_2024} & 1-PA & MEEM & LD & 2 & T & NL P & - & - & - & - & IRR
& GA & PWR & GEO & DIM, SHP, CTL & 8 \\

\citet{housner_numerical_2024} & TRM & BEM & - & 4 & T & PI & DYN & - & - & - & REG
& LOC & PWR & GEO & DIM, SHP, CTL & 3 \\

\citet{al_shami_parameter_2019} & 2-PA & BEM & DF & 2 & F & PI & - & - & - & - & REG
& DOE & PWR, BW & - & DIM, CTL, SHP & 7 \\

\citet{RM3} & 2-PA & BEM & Q & 2 & T & P & DES & - & FEA & FULL & IRR+, STO
& IT & - & - & - & - \\

\citet{mi_multi-scale_2025} & OSW & BEM & Various & 8 & T & PI & DYN, DES & DYN & FEA & FULL & IRR+, STO
& IT & - & - & - & - \\

\citet{an_optimal_2024} & OTP & CFD & CFD & - & T & - & - & - & FEA & - & STO
& ALT & ECON & STR & STR & 4 \\

\citet{ambuhl_reliability-based_2014} & 1-PA & - & Q & - & - & - & DES & - & AN & STR & STO
& BF & ECON & STR, STA & DIM, STR & 3 \\

\citet{nguyen_theoretical_2024} & OSW & MEEM & LD & 1 & F & PI & - & - & LD & - & IRR
& BF & ECON, LD & - & DIM & 2 \\

\citet{ferri_balancing_2014} & 1-PA & BEM & LD & 1 & T & P, PI+, UNS & - & DYN & LD & STR & IRR+
& LOC & PWR, LD & AMP, PTO & CTL & 3 \\

\citet{rosati_control_2023} & OWC & BEM & - & 1 & T & NL P+ & - & EFF & - & PTO & IRR+
& BF & ECON, VAR & PTO & PTO, CTL & 2 \\

\citet{son_performance_2016} & 2-PA & MEEM & LD & 1 & F & P & - & EFF & - & - & REG
& BF & PWR & - & PTO & 2 \\

\citet{gaebele_tpl_2025} & 2-PA & BEM & - & 2 & PS & PI & - & DYN, EFF & - & PTO, GEO & IRR
& LOC & ECON & PTO & PTO, CTL, DIM & 5 \\

\citet{devin_high-dimensional_2024} & 1-PA & FIT & - & 1 & PS & UNS & - & DYN, EFF & - & - & REG
& DOE, BF, LOC & PWR & PTO & PTO, CTL & 5 \\

\citet{grasberger_control_2024} & OSW & BEM & - & 1 & PS & PI & - & DYN & - & GEO & IRR
& BF, LOC & ECON & AMP, PTO & DIM, PTO, CTL & 2 \\

\citet{herber_dynamic_2014} & 1-PA & FIT & LD & 1 & T & UNS & - & - & - & - & IRR& BF, LOC & PWR & AMP, PTO & DIM, CTL & 2 \\

\citet{lin_fast_2025} & 1-PA & BEM & LD & 1 & F+ & UNS & - & - & - & - & IRR+
& BF, PMP & ECON & AMP, PTO & DIM & 1 \\

\citet{abdulkadir_optimal_2024} & 1-PA array & BEM & - & 3 & T & UNS & - & - & - & - & IRR
& PMP & PWR & PTO & CTL & - \\
...
\ifdefined\DISSERTATION
    ...
    \citet{garcia-teruel_reliability-based_2021} and the smaller-scale \cite{garcia-teruel_design_2022} apply multi-objective optimization to trade off power with fatigue load and device volume respectively.
    ...
    \citet{mcgilton_optimal_2024} reports only 3\% energy loss from a 70\% force-rating reduction across multiple device archetypes (RM3, RM5), sites, and scales, supporting analytical predictions in \cite{coe_maybe_2021,devin_high-dimensional_2024}.
    ...
    \else
    Of the multi-discipline studies in \cref{remdo:tab:lit}, the largest in scope are \cite{khanal_multi-objective_2024} (four-WEC array layout, hydrodynamics, controls, and economics), \cite{gaudin_single_2021} (20-cylinder site/layout/mooring at fixed device design), \cite{edwards_optimisation_2022} (point-absorber shape with stability constraints), and \cite{garcia-teruel_reliability-based_2021,garcia-teruel_design_2022,cotten_multi-objective_2022} (power-versus-fatigue-load or power-versus-volume trade-offs).
...
\ifdefined\DISSERTATION
    ...
    Semi-analytical models offer a uniquely suitable combination of speed and accuracy for early-stage WEC optimization, where the model must be run thousands of times and where smooth dependence on inputs facilitates accurate gradients \cite{mccabe_development_2026}.
    This study uses the MDOcean framework \cite{mccabe_development_2026}, which integrates semi-analytical models across hydrodynamics, dynamics and control, structures, and economics, to enable a WEC optimization of unprecedented scope.
\else
...
\ifdefined\DISSERTATION
    This paper applies the MDOcean framework \cite{mccabe_development_2026} to what is believed to be the most comprehensive WEC techno-economic design optimization to date.
    ...
    \Cref{remdo:sec:optim-methods} describes the optimization methodology, including the underlying model overview and references to \cite{mccabe_development_2026} for modeling details.
    ...
    \Cref{remdo:sec:discussion} interprets the trends, presents three representative optimal designs, and outlines future work.
\else
    This paper applies the MDOcean framework \cite{mccabe_development_2026} to what is believed to be the most comprehensive WEC techno-economic design optimization to date.
    The contributions are: a multidisciplinary problem formulation simultaneously varying 12 design variables across bulk dimensions, structural thicknesses, and powertrain ratings subject to static, dynamic, structural, and operational constraints;
    ...
    single- and multi-objective results with sensitivity analysis revealing drivers of LCOE, cost, and power, and identifying a non-convex Pareto cusp tied to a force-saturation to power-saturation strategy shift;
    and design recommendations distinguishing utility-scale from Powering-the-Blue-Economy applications.

    The remainder of the paper is organized as follows.
    \Cref{remdo:sec:optim-methods} describes the optimization methodology and references \cite{mccabe_development_2026} for the underlying simulation model.
    \Cref{remdo:sec:formulation} develops the problem formulation and \cref{remdo:sec:optim-process} the solution procedure.
    \Cref{remdo:sec:results} presents results; \cref{remdo:sec:discussion} interprets them and outlines future work.
\fi
