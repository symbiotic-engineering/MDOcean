...
%Storm sea states (m, s) & $H_{s,\text{storm}},T_{e,\text{storm}}$ &  &  &  &  \\ 
...
Opt. float-spar clearance height & $h_{fs,\text{clear}}^*$ & $3.9 $ & $3.93 $ & $3.99 $ & $1.8 $ \\ 
Opt. maximum force & $F_{\text{max}}^*$ & $2.44 $ & $3.36 $ & $6.61 $ & $2.98 $ \\ 
Opt. maximum power & $P_{\text{max}}^*$ & $286 $ & $286 $ & $286 $ & $288 $ \\ 
...
Opt. float stiffener height & $h_{\text{stiff},f}^*$ & $170 \cdot 10^{-3}$ & $196 \cdot 10^{-3}$ & $249 \cdot 10^{-3}$ & $261 \cdot 10^{-3}$ \\ 
Opt. damping plate stiffener height & $h_{1,\text{stiff},d}^*$ & $389 \cdot 10^{-3}$ & $423 \cdot 10^{-3}$ & $585 \cdot 10^{-3}$ & $956 \cdot 10^{-3}$ \\ 
