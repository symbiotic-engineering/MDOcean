...
\item Optimal designs achieve up to \resultsRE[pctImproveLCOEMinLCOE]~LCOE reduction and tend to be \resultsRE[optDesignDescriptionMinLCOE]~than the standard RM3 design
...
\item Single- and dual-objective optimization require \resultsRE[singleObjFcnEvals]~and over \resultsRE[paretoFcnEvals]~function evaluations respectively.
\end{highlights}
...
\bibliographystyle{elsarticle-num-names} % due to latexmk quirks, the bst path should be relative to the out dir not the main tex file
