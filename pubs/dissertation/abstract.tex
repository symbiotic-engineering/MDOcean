...
The model also calculates information about the water around the WEC by assuming the WEC is shaped like a set of concentric cylinders,
...
Our method ensures that we consider how the different parts of the WEC affect each other, and how we can be more confident in our predictions even if we aren't sure about some of the inputs to the model.
