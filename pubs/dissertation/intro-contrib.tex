...
\ifdefined\DECIDER
  ...
  \item Proposes three methods to structure the above optimization (CEM in the loop, CEM sweep with reduced-order WEC design, and the price-taker assumption with value matrix) and compares their relevance, fidelity, and limitations
