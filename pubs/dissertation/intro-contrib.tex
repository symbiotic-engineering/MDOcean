...
Key message: Multidisciplinary design optimization exploits careful problem formulation and full coupling to reveal the way that \gls{acr-wec} shape and size mediate the tradeoff between cost and power.
\begin{itemize}
...
\ifdefined\DECIDER
  ...
  \item Proposes three methods to structure the above optimization (CEM in the loop, CEM sweep with reduced-order \gls{acr-wec} design, and price-taker assumption with value matrix) and compares their relevance, fidelity, and limitations
