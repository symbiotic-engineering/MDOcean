...
However, it remains unknown what size, shape, operation, and design tradeoffs of a \gls{acr-wec} will most effectively contribute to global decarbonization efforts.
...
Several attempts have been made to optimize \glspl{acr-wec}, but they have been limited in scope, rigor, and relevance.
...
\else
  Finally, to
\fi
obtain decision-relevant insights, the MDOcean framework is then applied in a design optimization study, which constitutes \Cref{ch:optimization} of the dissertation. 
\ifdefined\DECIDER
...
\begin{itemize}
\item Presents a unifying matched eigenfunction expansion method framework for modeling an arbitrary number of fixed or heaving surface-piercing annular cylinders.
...
\item Systematically explores convergence behavior and outlines a truncation order prediction procedure achieving within 2\% of the target accuracy.
\item Demonstrates <5\% error for slanted geometries, even for angles as steep as $15^\circ$ from vertical.
...
Key message: \gls{acr-mdo} exploits careful problem formulation and full coupling to reveal the way that \gls{acr-wec} shape and size mediate the tradeoff between cost and power.
\begin{itemize}
...
\ifdefined\DECIDER
  ...
  \item Argues that wave energy can provide grid planners/operators with substantial value and that designing for grid value can bring \glspl{acr-wec} closer to economic viability, though this can only occur if the energy market design appropriately monetizes and incentivizes this
  ...
  \item Proposes three methods to structure the above optimization (CEM in the loop, CEM sweep with reduced-order \gls{acr-wec} design, and the price-taker assumption with value matrix) and compares their relevance, fidelity, and limitations

  \item Expands on the implementation of CEM sweep with reduced-order \gls{acr-wec} design, shows that a second-order \gls{acr-wec} model is insufficient for the above purposes, and proposes other reduced-order models to be explored in future work

  \item Expands on the implementation of the price-taker assumption with value matrix methodology: derives how capacity expansion model outputs can be used to obtain a value matrix that intuitively shows the variation of grid effects with sea state

  \item Shows that under the price-taker assumption, the convexity and structure of the net value of energy problem is identical to that of the levelized cost of energy problem; only the weight of power in each sea state changes
...
\begin{typedlist}
    \titem{r} McCabe, ``Leveraging Semi-Analytical Modeling, Multidisciplinary Design Optimization, and System Value Metrics to Advance Wave Energy Converter Viability,'' dissertation (present document), August 2026. Any error corrections or updates will be posted at \url{https://calkit.io/symbiotic-engineering/mdocean/publications?path=pubs%2Fdissertation%2FsampleThesis.pdf}.
    \titem{p} McCabe, ``Leveraging Semi-Analytical Modeling, Multidisciplinary Design Optimization, and System Value Metrics to Advance Wave Energy Converter Viability,'' dissertation defense, May 2026. \url{https://vod.video.cornell.edu/media/t/1_d7sd33c2}.
    ...
    \titem{f} McCabe, National Science Foundation Graduate Research Fellowship, 2021-2026. Grant no. DGE--2139899.
\end{typedlist}
%
\noindent
Contribution 1: System Modeling
\begin{typedlist}
  \titem{j} McCabe, Dietrich, and Haji, ``Development, Validation, and Benchmarking of a Multidisciplinary Semi-Analytical Model for Wave Energy Converters,'' in review for Applied Ocean Research, submission APOR-D-26-00768. \url{https://doi.org/10.48550/arXiv.2606.22739}.
...
\begin{typedlist}
  ...
  \titem{o} Hope Best, Rebecca McCabe, Kapil Khanal, Yinghui Bimali, En Lo, Ruiyang Jiang, John Fernandez, Collin Treacy, and Maha N. Haji. ``OpenFLASH.'' Zenodo, June 6, 2026. \url{https://doi.org/10.5281/zenodo.17453418}, \url{https://github.com/symbiotic-engineering/OpenFLASH}.
...
\begin{typedlist}
    \titem{j} McCabe, Dietrich, and Haji, ``Leveraging Multidisciplinary Design Optimization to Advance Wave Energy Converter Viability,'' in preparation to resubmit to Renewable Energy in August 2026. \url{https://calkit.io/symbiotic-engineering/mdocean/publications#pubs/renewable-energy-mdo/mdocean.pdf}.
    \titem{p} McCabe, Dietrich, and Haji, ``MDOcean: an Open-Source Software for Efficient Simulation and Multidisciplinary Design Optimization of \glspl{acr-wec},'' University Marine Energy Research Community Conference, August 2025. Best presentation award. \url{https://doi.org/10.5281/zenodo.20546351}.
...
\begin{typedlist}
    ...
    \titem{o} Rebecca McCabe, Jiarui Yang, Alan Liu, Kalvindra Parasram, Khai Xin Kuan, En Lo, Madison Dietrich, and Rumman Jan. ``WEC-DECIDER.'' GitHub, 2026. \url{https://github.com/symbiotic-engineering/WEC-DECIDER}.
    ...
    \titem{r} McCabe, 2023. ``CEE 6880 Final Project: Exploring the Value of Wave Energy with a Capacity Expansion Model.'' \url{https://github.com/symbiotic-engineering/WEC-DECIDER/blob/main/modules/CEM/old/report.pdf}.
    \titem{r} McCabe, 2022. ``CEE 5200 Final Report: The Net Temporal Value of Wave Energy on the California Grid.'' \url{https://github.com/rebeccamccabe/wec-econ/blob/main/CEE_5200___Wave_Energy_Economics.pdf}.
...
\begin{typedlist}
    ...
    \titem{f} McCabe, DeGeode, Vitale, Pokigo, Srivastava, Edwards, and Haji, ``CArbon Sequestration Harnessing Energy from Waves (CASHEW) Concept,'' U.S. Department of Energy, Power at Sea Prize Concept phase winner. \url{https://github.com/symbiotic-engineering/CASHEW/blob/main/pubs/CASHEW_power_at_sea_prize.pdf}.
    \titem{o} DeGeode, McCabe, Pokigo, Patel, Doherty, Srivastava, Edwards, Vitale, and Haji. ``CASHEW.'' \url{https://github.com/symbiotic-engineering/CASHEW}.
\end{typedlist}
%
\noindent
...
%
\noindent
WEC Generator Design:
\begin{typedlist}
  \titem{r} McCabe, Grier, Miramontes Serrano, Resch, and Haji, ``Surface Permanent Magnet Generator Design for a Wave Energy Converter,'' 2024. \url{https://github.com/symbiotic-engineering/wec-generator/blob/main/pubs/ECCE_digest.pdf}.
\end{typedlist}