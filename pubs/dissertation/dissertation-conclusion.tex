...
The hydrodynamics module could be extended to incorporate more of the insights gained from the convergence study, geometry generalizations, and numerical improvements of \Cref{ch:hydrodynamic}, and the analysis of \Cref{ch:hydrodynamic} itself could be extended by repeating the matrix structure study for fluid regions with boundary conditions that represent damping plates, non-cylindrical geometries, second-order forces.
The optimization could be improved by promoting several geometric parameters to be design variables in accordance with the findings of \Cref{ch:optimization}, exploring creative concepts for surviviability and amplitude constraints, more fully comparing the effect of different model assumptions and objective formulations, incorporating adjoint or analytical derivatives including post-optimality sensitivities of the analytical QCQP at each iteration of the outer optimization, and assessing additional locations to better understand the dependence of the optimal on the wave environment.

% make my sim faster like it used to be
% software integration with wecsim and wecopttool and raft etc - in OpenMDAO to take advantage of state of the art MDO visualizations, algorithms, automated sensitivities
