...
In addition to the NSF GRFP, the author received the following sources of financial support related to this research:
\begin{itemize}
  \item Cornell Graduate School Provost's Diversity Fellowship;
  \item Cornell \gls{acr-mae} McMullen Fellowship;
  \item \gls{acr-umerc} Conference Travel and Registration Grant;
  \item \gls{acr-asme} \gls{acr-idetccie} Broadening Participation (BPart) Award;
  \item Cornell Graduate School Travel Grant;
  \item Department of Energy Water Power Technologies Office Power at Sea Prize (Concept Phase);
  \item Department of Energy Water Power Technologies Office Innovating Distributed Embedded Energy Prize (InDEEP Phase I and II);
  \item Cornell \gls{acr-mae} Bart Conta Prize for Energy and the Environment.
\end{itemize}

While the author did not directly receive funding from the following sources, collaborators supporting the research described herein were funded in part by:
\begin{itemize}
  \item Sandia National Laboratories through the Marine Energy Seedlings Program for National Laboratories from the U.S. Department of Energy and
  Sandia's Laboratory Directed Research \& Development (LDRD) program through the Sandia University Partnerships Network. 
  ...
  \item Cornell Engineering Learning Initiatives through the Fund for Undergraduate Research on Solutions to Climate Change,
  the Bill Nye '77 Award in Undergraduate Research, Robert A. Cowie '55 ME, and the Dean Archer Undergraduate Research Program.
\end{itemize}

The author declares the following non-financial relationships that may be considered potential conflicts of interest:
Rebecca McCabe received research-related administrative support from New York State Education Department Adult Career and Continuing Education Services Vocational Rehabilitation Services (ACCES-VR) and from Productive For Good Coaching in 2025-2026.
Maha Haji held board membership on \gls{acr-umerc} in 2024.
...
\begin{itemize}
  ...
  I especially thank Pete for exchanging over 150 GitHub issues with me;
  ...
  including Rachel Clark and Dawn Plue at Cornell Health; Erin Forquer, psychologist; Ila Rose at Finger Lakes Independence Center; and Matt Jarman at Productive for Good.
  You all cared when others didn't, which made a real difference in my ability to finish the PhD.
\end{itemize}
...
\begin{itemize}
  ...
  Can Jam on the fifth floor of Upson, the bouncy-ball game at PhD meetings, morning runs around Beebe, the UMERC hot tub, and associated antics made the lab fun. One day we'll build a nuclear outer-space \gls{acr-wec}.
  \item Olivia V. for being my best friend in the lab, conference buddy, 
  prototyping pal, and for being there for each other when our PhDs were hard. I'm so glad that you got to test in the big wave tank, and sorry that I couldn't be there to see it.
  ...
  for the grounded lighthearted energy and stability you bring to the lab,
  ...
  \item All 39 undergrad researchers whom I've had the pleasure of mentoring, in chronological order:
  Gabriel, Haley, Robert, Miriam, Andrea, Sofia, Madison D., Nelson, Larry, Mahika, Jacob, Alan, En, Kelvin, Nathan, Jordan, Sabian, Iris, Madison S., Leah, John, Cecily, Ehina, Maddie, Ben, Noam, Vidhi, Alex, Kotey, Moho, Kunj, Hope, Bimali, Ruiyang, Khai, Anthony, Rumman, Kalvin, and Amina.
  Teamwork is really important to me, and working with you all has been a highlight of my PhD.
  Special shout-outs go to Madison D., who has worked with me on MDOcean for 4 years and has grown so much;
  Bimali, who went above and beyond on the MEEM project and whose work features prominently in \Cref{ch:hydrodynamics};
...
\begin{itemize}
  ...
  \item Andrea, my former roommate, for the spontaneous runs, deep reflections, casual speculative physics, and meaningful conversations about social impact.
  ...
  inviting me on that barefoot 4 a.m.\ walk to Goldwin Smith, 
...
\begin{itemize}
  ...
  You both keep a watchful eye on the Cornell red-tailed hawk cam, 
