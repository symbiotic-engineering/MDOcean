...
\begin{aligned}
    \gls{sym-xi-max-slam} &= \frac{\gls{sym-H}}{2} \cos\gls{sym-theta} + \sqrt{\gls{sym-Delta} \gls{sym-z-slam}^2-\left(\frac{\gls{sym-H}}{2}\sin\gls{sym-theta}\right)^2 } \\
    \gls{sym-xi-min-slam} &= \frac{\gls{sym-H}}{2} \cos\gls{sym-theta} - \sqrt{\gls{sym-Delta} \gls{sym-z-slam}^2-\left(\frac{\gls{sym-H}}{2}\sin\gls{sym-theta}\right)^2 }
\end{aligned}
\end{equation}
...
For float slamming, $\gls{sym-Delta} \gls{sym-z} = \gls{sym-T-f-1}$ (rather than $\gls{sym-T-f-2}$):
...
$\gls{sym-Delta} \gls{sym-z} = \gls{sym-T-f-2}$
