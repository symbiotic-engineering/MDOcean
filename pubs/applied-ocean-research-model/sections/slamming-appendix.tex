...
Intuitively, $\gls{sym-theta}$ represents how high up the free surface the bottom of the WEC is allowed to get before the edge exits the water,
...
At any lower amplitude, the WEC would exit the water at the wave trough,
and any higher, the WEC would raise out of the water at the wave crest.
...
The widest permissible amplitude range occurs when the WEC is perfectly in-phase with the incident wave
...
While preventing slamming requires that the bottom of the WEC remains below the free surface,
preventing submersion requires that the top of the WEC remains above the free surface.
