...
\begin{table}[htbp]
 ...
 & & $\gls{sym-vec-C-1n-i1-2}$& $\gls{sym-vec-C-1m-i2-2}$& $\gls{sym-vec-C-2m-i2-2}$&$\gls{sym-vec-B-k-e}$\\\hline
          ...
          \\ \hline \hline
            ...
            &  $-\gls{sym-boldsymbol-mathcal-Z}_{nm}\odot 1_{N1}\gls{sym-vec-R-1m-i2}$
            &  $-\gls{sym-boldsymbol-mathcal-Z}_{nm}\odot 1_{N1}\gls{sym-vec-R-2m-i2}$& $0_{NK}$
          \\ \hline
            \shortstack{
            ...
            & $-\gls{sym-boldsymbol-mathcal-Z}_{mk}\odot 1_{M1}\vec{\Lambda}_{\gls{sym-k-index}}$
          \\ \hline
            \shortstack{
            ...
            &M
            &  $- \gls{sym-boldsymbol-mathcal-Z}_{mn} \odot 1_{M1} \frac{\partial}{\partial \gls{sym-r}}\gls{sym-vec-R-1n-i1}$
          ...
          \\ \hline
            \shortstack{
                ...
                &K
            &  $0_{KN}$
            &  $-\gls{sym-boldsymbol-mathcal-Z}_{km} \odot 1_{K1}\frac{\partial}{\partial \gls{sym-r}}\gls{sym-vec-R-1m-i2}$
            &  $-\gls{sym-boldsymbol-mathcal-Z}_{km} \odot 1_{K1}\frac{\partial}{\partial \gls{sym-r}}\gls{sym-vec-R-2m-i2}$
...
\begin{aligned}
    ...
    \gls{sym-boldsymbol-mathcal-Z}_{m,k=0}
    &
...
are placed on $\gls{sym-m-k}h$ in a root-finding algorithm to ensure the $\gls{sym-k-index}$th root is identified.
