...
\begin{figure}[htb]
\centering
\includegraphics{figs/from-matlab/meem_dims.pdf}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.45\linewidth]{figs/from-matlab/meem_sparsity.pdf}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\linewidth]{figs/from-matlab/meem_validation.pdf}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\linewidth]{figs/from-matlab/meem_matching.pdf}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\linewidth]{figs/from-matlab/meem_convergence_vs_omega.pdf}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=.5\linewidth]{figs/from-matlab/asymptotic_b_vector.pdf}
