...
\begin{tabular}{|l|c|c|c|c|} \hline
          Body&N&  M&  M& K\\ \hline
          Float&$0_{1\gls{sym-N}}$&  $\gls{sym-vec-Z-m-i2}(\gls{sym-z}=-d) \odot\gls{sym-boldsymbol-mathcal-R}_{1m}$&  $\gls{sym-vec-Z-m-i2}(\gls{sym-z}=-d) \odot\gls{sym-boldsymbol-mathcal-R}_{2m}$& $0_{1\gls{sym-K}}$\\ \hline
          Spar& $\gls{sym-vec-Z-n-i1}(\gls{sym-z}=-d) \odot\gls{sym-boldsymbol-mathcal-R}_{1n}$& $0_{1\gls{sym-M}}$& $0_{1\gls{sym-M}}$&$0_{1\gls{sym-K}}$\\\hline
    \end{tabular}
    \end{table}
