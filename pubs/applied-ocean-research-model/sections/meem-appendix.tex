        ...
        &  $\gls{sym-R-1n-i1} (\gls{sym-r})
            ...
            \begin{cases}
                ...
                \frac{
                    ...
                    \gls{sym-mathrm-I-0}
                    (\gls{sym-lambda}_{\gls{sym-n}}^{i1}\gls{sym-a-2})
                }
                    & \gls{sym-n}\ge1
            \end{cases}$
        &  \shortstack{
            ...
            \begin{cases}
                ...
                \frac{
                    ...
                    \gls{sym-mathrm-I-0}
                    (\gls{sym-lambda}_{\gls{sym-m}}^{i2}\gls{sym-a-2})
                }
                    & \gls{sym-m}\ge1
            \end{cases}
            $
...
\newcommand{\RintTwoJOne}{
    ...
    \frac
    {
        \gls{sym-a-in}\,\gls{sym-mathrm-K-1} (\gls{sym-vec-lambda}_{\gls{sym-m}} \gls{sym-a-in})
        -\gls{sym-a-out}\,\gls{sym-mathrm-K-1} (\gls{sym-vec-lambda}_{\gls{sym-m}} \gls{sym-a-out})
    }
    {
