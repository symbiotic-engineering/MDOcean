...
\newcommand{\RintTwoDefn}{
    $\displaystyle \gls{sym-boldsymbol-mathcal-R}_{2m} = \int\limits_{\gls{sym-a-in}}^{\gls{sym-a-out}} \gls{sym-vec-R}_{2m}(\gls{sym-r})rdr$
}
...
\begin{tabular}{|l|c|c|c|c|} \hline
          Body&N&  M&  M& K\\ \hline
          Float&$0_{1\gls{sym-N}}$&  $\gls{sym-vec-Z-m}(\gls{sym-z}=-d) \odot\gls{sym-boldsymbol-mathcal-R}_{1m}$&  $\gls{sym-vec-Z-m}(\gls{sym-z}=-d) \odot\gls{sym-boldsymbol-mathcal-R}_{2m}$& $0_{1\gls{sym-K}}$\\ \hline
          Spar& $\gls{sym-vec-Z-n}(\gls{sym-z}=-d) \odot\gls{sym-boldsymbol-mathcal-R}_{1n}$& $0_{1\gls{sym-M}}$& $0_{1\gls{sym-M}}$&$0_{1\gls{sym-K}}$\\\hline
    \end{tabular}
    \end{table}
