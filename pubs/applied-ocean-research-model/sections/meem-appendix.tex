...
\newcommand{\RintOneJOne}{
    $\displaystyle
        \frac
            {\gls{sym-a-out} \gls{sym-mathrm-I-1} (\gls{sym-vec-lambda-j} \gls{sym-a-out}) - \gls{sym-a-in}\gls{sym-mathrm-I-1} (\gls{sym-vec-lambda-j} \gls{sym-a-in})}
            {\gls{sym-vec-lambda-j} \gls{sym-mathrm-I-0} (\gls{sym-vec-lambda-j} \gls{sym-a-2})}
    $
}
