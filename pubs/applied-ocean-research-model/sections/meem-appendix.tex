...
\begin{table}[htbp]
    ...
    \begin{tabular}{|M{0.069\linewidth}|M{0.29\linewidth}|M{0.29\linewidth}|M{0.25\linewidth}|} \hline 
    \else
    \begin{tabular}{|P{0.085\linewidth}|P{0.26\linewidth}|P{0.34\linewidth}|P{0.32\linewidth}|} \hline 
    \fi
