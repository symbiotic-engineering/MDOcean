...
\begin{figure}
\centering
\includegraphics[width=1\linewidth]{figs/from-matlab/taxonomy.pdf}
...
MDAO is a quantitative methodology to formulate, solve, and interpret the results of complex engineering design problems that involve multiple coupled disciplines \cite{agte_mdo_2010}.
