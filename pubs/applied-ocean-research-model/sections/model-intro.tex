...
Nonlinear forces such as drag are most often linearized and included as an additional linear damping (LD), though other methods exist including quadratic representaton (Q), describing function (DF), strip-theory integration of Morison's equation (M), and CFD.
...
Automating the design process reported there remains a long term vision for WEC multidisciplinary.
