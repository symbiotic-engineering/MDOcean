...
While the present paper does not perform optimization, the model is developed specifically with optimization in mind and is therefore showcased in an optimization context.
...
An optimizer would use the objective $J$ and constraint $g$ outputs from a simulation run to inform the next iteration of design variables $x$, iterating until ultimately converging to a set of optimal values $x^*$, $J^*$, and $g^*$.
...
\begin{figure}
\centering
\includegraphics[width=\linewidth]{../applied-ocean-research-model/figs/from-matlab/xdsm.pdf}
...
\begin{figure}
\centering
\includegraphics[width=1.1\linewidth]{../applied-ocean-research-model/figs/from-matlab/control_analysis_flowcharts.pdf}
