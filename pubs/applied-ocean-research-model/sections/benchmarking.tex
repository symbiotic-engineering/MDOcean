...
The MEEM hydrodynamic coefficients for the nominal RM3 geometry match WAMIT BEM results closely, as previously shown in Fig.~3 of \cite{mccabe_open-source_2024}.
The comparison is reproduced here in spirit: MEEM results for the simplified cylindrical geometry are a close match to WAMIT BEM results for the exact RM3 geometry, except at frequencies below 0.3~rad/s.
...
Since that paper, excitation phase has been added to the MEEM implementation and also tracks well.
