...
The absolute error in average power compared to the WEC-Sim power is less than \resultsAOR[wecsimAvgPowerErrorBestCase] in the best case and \resultsAOR[wecsimAvgPowerErrorWorstCase] in the worst case, with an error breakdown for all simulation scenarios and sea states shown in Figure~\ref{fig:error-histogram}.

\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{../applied-ocean-research-model/figs/from-matlab/wecsim_geom_wecsim_multibody_true__histogram.pdf}
...
\begin{table}[]
\centering
\input{../applied-ocean-research-model/tables/from-matlab/validation.tex}
\caption{Validation}
\label{tab:validation}
\end{table}
...
The MEEM hydrodynamics module takes the majority (\resultsAOR[pctRuntimeMEEM]) of the time and is broken down in \figureautorefname~\ref{fig:runtime-hydro}.
...
\begin{figure}
\centering
\includegraphics[width=\linewidth]{../applied-ocean-research-model/figs/from-matlab/sim_runtime.pdf}
\caption{Bar chart showing simulation runtime breakdown between modules}\label{fig:runtime-modules}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=\linewidth]{../applied-ocean-research-model/figs/from-matlab/hydro_runtime_logscale.pdf}
...
\begin{figure}
\centering
\includegraphics[width=\linewidth]{../applied-ocean-research-model/figs/from-matlab/dynamics_runtime.pdf}
