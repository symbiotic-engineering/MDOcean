...
These errors are deemed acceptable for the purposes of this study, since the goal is to demonstrate the value of simultaneously optimizing multiple disciplines and the ability to quickly evaluate a large number of design options.
...
Since that paper, excitation phase has been added to the MEEM implementation and also matches WAMIT results well.
...
The scaling behavior of economic outputs against the number of WECs is validated by sweeping $N_{WEC}$ from 1 to 100 and comparing the simulated CAPEX, OPEX, and LCOE against the \cite{RM3} reference values.
