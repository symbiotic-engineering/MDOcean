...
\end{figure}
Errors are 38.2\% and 28.6\% on the average power and maximum amplitude respectively.
Though this seems large, the extremely low errors in the system enforcing the same hydrodynamic coefficients as WEC-Sim and with zero drag (0.2\% and 1.9\% in power and amplitude respectively) indicate that this is not an error in the dynamic model itself, but in the way that the model amplifies errors in drag and hydrodynamic coefficients. 
