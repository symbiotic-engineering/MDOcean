...
\begin{equation}\label{eq:drag-alpha-definitions}
    \gls{sym-vec-alpha-v-y} = \frac{|\gls{sym-vec-hat-V-rel-2}(\gls{sym-y})|}{|\gls{sym-vec-hat-dot-xi}|} = \sqrt{1 + \gls{sym-vec-r}^{\, 2} \exp(-2\gls{sym-k-wavenumber}\gls{sym-y}) - 2 \gls{sym-vec-r} \exp(-\gls{sym-k-wavenumber}\gls{sym-y})  \sin\angle \gls{sym-vec-hat-dot-xi}}
\end{equation}
and $\gls{sym-vec-r} = |\gls{sym-hat-V-wave}|/ |\gls{sym-vec-hat-dot-xi}|$ is the amplitude ratio of the incident wave velocity and WEC velocity.
...
\begin{aligned}
    ...
    \left[
        I_B(r,\angle\hat{\dot{\xi}},\gls{sym-k-wavenumber}R) - \alpha^2 I_B(r,\angle\hat{\dot{\xi}},\alpha \gls{sym-k-wavenumber} R)
    \right]
    \\
    \gls{sym-vec-gamma-d} &= \frac{8}{3\pi} \rho_w R^2 C_d |\hat{\dot{\xi}}| \frac{g \gls{sym-k-wavenumber}}{\omega} \exp(-\gls{sym-k-wavenumber}\vec{T})
    \left[
        \gls{sym-I-G}(r,\angle\hat{\dot{\xi}},\gls{sym-k-wavenumber}R) - \alpha^2 \gls{sym-I-G}(r,\angle\hat{\dot{\xi}},\alpha \gls{sym-k-wavenumber}R)
    \right]
\end{aligned}
\end{equation}
...
\begin{aligned}
    \gls{sym-I-B}(r,\theta,\kappa) &= \int_{-1}^1 \sqrt{1-x^2}\sqrt{1+r^2\exp(-2\kappa x)-2r\sin\theta \exp(-\kappa x)} dx
    \\
    \gls{sym-I-G}(r,\theta,\kappa) &= \int_{-1}^1 \sqrt{1-x^2}\sqrt{1+r^2\exp(-2\kappa x)-2r\sin\theta \exp(-\kappa x)} \exp(-i\kappa x) dx
\end{aligned}
\end{equation}
...
\begin{aligned}
    ...
    \right]
    \\
    \gls{sym-vec-gamma-d} &= \frac{8}{3\pi} \rho_w R^2 C_d  |\hat{V}_{wave}| \frac{g\gls{sym-k-wavenumber}}{\omega} \exp(-\gls{sym-k-wavenumber}\vec{T})
    \left[
        I_G'(r,\angle\hat{\dot{\xi}},\gls{sym-k-wavenumber}R) - \alpha^2 I_G'(r,\angle\hat{\dot{\xi}},\alpha \gls{sym-k-wavenumber}R)
    \right]
\end{aligned}
\end{equation}
