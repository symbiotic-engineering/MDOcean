...
\begin{aligned}
    ...
    \gls{sym-vec-gamma-d} &= \frac{8}{3\gls{sym-pi}} \frac{1}{2} \gls{sym-rho-w} \gls{sym-vec-C-d} \, |\gls{sym-vec-dot-xi}| \frac{\gls{sym-g}\gls{sym-k-wavenumber}e^{-\gls{sym-k-wavenumber}\gls{sym-vec-T}}}{\gls{sym-omega}} \int_{\gls{sym-y}=-\gls{sym-vec-R}}^{\gls{sym-vec-R}} \gls{sym-vec-w-y} \gls{sym-vec-alpha-v-y} e^{-i\gls{sym-k-wavenumber}\gls{sym-y}} d\gls{sym-y}
\end{aligned}
\end{equation}
