...
\begin{equation}
    ...
    \gls{sym-vec-hat-V-wave}(\gls{sym-y}) = \frac{\gls{sym-H}}{2}\,\frac{\gls{sym-g}\gls{sym-k}}{\gls{sym-omega}}\, \exp\{-\gls{sym-k}\gls{sym-vec-T}-i\gls{sym-k}\gls{sym-y}\}.
\end{equation}
...
\begin{aligned}
    \gls{sym-mathbf-B-d} &= \frac{8}{3\gls{sym-pi}}\frac{1}{2} \gls{sym-rho-w} \, \textrm{diag}\left(\gls{sym-vec-C-d} |\gls{sym-vec-dot-xi}| \int_{\gls{sym-y}=-\gls{sym-vec-R}}^{\gls{sym-vec-R}} \gls{sym-vec-w-y} \gls{sym-vec-alpha-v}(\gls{sym-y}) d\gls{sym-y} \right) \\
    \gls{sym-vec-gamma-d} &= \frac{8}{3\gls{sym-pi}} \frac{1}{2} \gls{sym-rho-w} \gls{sym-vec-C-d} \, |\gls{sym-vec-dot-xi}| \frac{\gls{sym-g}\gls{sym-k}e^{-\gls{sym-k}\gls{sym-vec-T}}}{\gls{sym-omega}} \int_{\gls{sym-y}=-\gls{sym-vec-R}}^{\gls{sym-vec-R}} \gls{sym-vec-w-y} \gls{sym-vec-alpha-v-y} e^{-i\gls{sym-k}\gls{sym-y}} d\gls{sym-y}
\end{aligned}
\end{equation}
...
\begin{equation}\label{eq:drag-alpha-definitions}
    \gls{sym-vec-alpha-v-y} = \frac{|\gls{sym-vec-hat-V-rel-2}(\gls{sym-y})|}{|\gls{sym-vec-dot-xi}|} = \sqrt{1 + \gls{sym-vec-r}^{\, 2} \exp\{-2ky\} - 2 \gls{sym-vec-r} \exp\{-ky\}  \sin\angle \gls{sym-vec-hat-dot-xi}}
\end{equation}
