...
\begin{aligned}
    \gls{sym-I-B}(\gls{sym-r},\gls{sym-theta},\gls{sym-kappa}) &= \int_{-1}^1 \sqrt{1-\gls{sym-x}^2}\sqrt{1+\gls{sym-r}^2\exp(-2\gls{sym-kappa} \gls{sym-x})-2\gls{sym-r}\sin\gls{sym-theta} \exp(-\gls{sym-kappa} \gls{sym-x})} dx
    \\
    \gls{sym-I-G}(\gls{sym-r},\gls{sym-theta},\gls{sym-kappa}) &= \int_{-1}^1 \sqrt{1-\gls{sym-x}^2}\sqrt{1+\gls{sym-r}^2\exp(-2\gls{sym-kappa} \gls{sym-x})-2\gls{sym-r}\sin\gls{sym-theta} \exp(-\gls{sym-kappa} \gls{sym-x})} \exp(-i\gls{sym-kappa}\gls{sym-x}) dx
\end{aligned}
\end{equation}
...
\begin{equation}
\begin{aligned}
    \lim_{\gls{sym-hat-e-r}\rightarrow 0} \gls{sym-I-B}(\gls{sym-hat-e-r},\gls{sym-theta},\gls{sym-kappa}) = \frac{\gls{sym-pi}}{2},
    \qquad
    ...
    \end{cases} \\
    \lim_{\gls{sym-kappa} \rightarrow 0} \gls{sym-I-B}(\gls{sym-hat-e-r},\gls{sym-theta},\gls{sym-kappa}) =  \lim_{\gls{sym-kappa} \rightarrow 0} \gls{sym-I-G}(\gls{sym-hat-e-r},\gls{sym-theta},\gls{sym-kappa}) = \frac{\gls{sym-pi}}{2}\sqrt{1+\gls{sym-hat-e-r}^2-2\gls{sym-hat-e-r}\sin\gls{sym-theta}},
\end{aligned}
\end{equation}
...
\begin{aligned}
    ...
    \begin{cases}
    \displaystyle\frac{\gls{sym-pi} \gls{sym-mathrm-J-1}((1i-1)\gls{sym-kappa})}{(1i-1)\gls{sym-kappa}} & \textrm{if } \gls{sym-kappa} \neq 0 \\
    \displaystyle\frac{\gls{sym-pi}}{2} & \textrm{if } \gls{sym-kappa} = 0
    \end{cases}
\end{aligned}
\end{equation}
