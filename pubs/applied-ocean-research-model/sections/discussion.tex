...
The minimum LCOE design experiences a storm surge force of \surgeForceFloatAtMinLCOE~MN on the float and \surgeForceSparAtMinLCOE~MN on the spar, compared to the nominal design's \surgeForceFloatNominal~MN and \surgeForceSparNominal~MN respectively.
