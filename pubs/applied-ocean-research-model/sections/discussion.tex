...
\begin{equation}
\mathbf{\eta}_{rad} = \mathbf{\eta}_{rad}(x_{shape}) \qquad
\mathbf{\eta}_{drag} = \mathbf{\eta}_{drag}(x_{shape},C_{d,f}, C_{d,s}) \qquad
\mathbf{\eta}_{force} = \mathbf{\eta}_{force}(x_{shape},C_{d,f}, C_{d,s},F_{max}) \qquad
...
The minimum LCOE design experiences a surge force of \surgeForceFloatAtMinLCOE~MN on the float and \surgeForceSparAtMinLCOE~MN on the spar, compared to the nominal design's \surgeForceFloatNominal~MN and \surgeForceSparNominal~MN respectively.
