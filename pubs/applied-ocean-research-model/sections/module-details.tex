...
& & b_i &\in \mathbb{R} \\[3pt]
& & \vec{c}^{\,*} &= \begin{bmatrix} 1 & Z_s \end{bmatrix} \\[3pt]
& & d &= \hat{V}_{s,th}
\end{aligned}
\end{equation}
...
\begin{aligned}
    \vec{x}_{opt} &= 
    \frac{\hat{V}_{s,th}}{2\Re(Z_s)}
        \begin{bmatrix} Z_s^* (1+\Gamma) \\ 1-\Gamma \end{bmatrix} \\
    P_{avg,VI,opt} &= \frac{|\hat{V}_{s,th}|^2}{8\Re(Z_s)}~ (1 - |\Gamma|^2)
\end{aligned}
\end{equation}
