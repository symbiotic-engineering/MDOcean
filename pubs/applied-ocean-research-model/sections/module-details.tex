...
\begin{equation}
    \vec{\hat{\xi}}_{storm} = \begin{bmatrix}
        \hat{\xi}_m 
    \end{bmatrix},~\vec{\gamma}_{storm} = \begin{bmatrix}
        \gamma_m
    \end{bmatrix},
...
\begin{table}
    ...
    \begin{tabular}{cc}
         ...
         $A_f$, $B_f$, $\gamma_f$, $B_m$, $\gamma_m$& MEEM\\
...
Finally, for merged geometry, MEEM is used to calculate the damping $B_m$ and excitation $\gamma_m$ since they are less affected by the damping plate, while the added mass $A_m$ is approximated as the sum of the float and spar coefficients:
