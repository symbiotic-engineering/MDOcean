...
Moving onto the candidates at intersection points, a quadratic function is concave if its leading order term is negative, and the leading order term of $\textrm{quad}(\gls{sym-b-mu}, \gls{sym-b-nu})$ is negative (arising from the subtraction of squared-affine term $\gls{sym-a-mu-nu-star}^2$).
