...
The closest-point candidates $\mathcal{C}_{cl}$ match the solution that \citet[\equationautorefname~4]{mccabe_force-limited_2024} derive for problems with only one constraint.
