...
& \text{s.t.} &
\gls{sym-S-mu}|\gls{sym-Gamma} - \Gamma_{c,\mu}|^2 &\le S_{\mu} r_{\mu}^2,
...
\begin{equation}\label{eq:gamma-opt-summary}
    ...
    & \text{none active} \\
        |\gls{sym-Gamma-c-mu}|^2
        - 2|\gls{sym-Gamma-c-mu}|\sqrt{\frac{\gls{sym-b-mu-star}+\gls{sym-c-mu-star}}{\gls{sym-d-mu-star}}}
    ...
    & \text{only $\gls{sym-mu}^*$ active} \\
        \left|
            ...
            \left(                \gls{sym-a-mu-nu-star}
                \pm
                1i \sqrt{\frac{\gls{sym-b-mu-star} + \gls{sym-c-mu-star}}{\gls{sym-d-mu-star}}-\gls{sym-a-mu-nu-star}^2}
            \right)
        \right|^2
