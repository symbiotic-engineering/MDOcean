...
$d_{\gls{sym-mu}^*,\gls{sym-nu}^*}$ is independent of the constraint limits, while $\gls{sym-a}_{\gls{sym-mu}^*,\gls{sym-nu}^*}$ is affine in $\gls{sym-b-mu-star}$ and $\gls{sym-b-nu-star}$.
