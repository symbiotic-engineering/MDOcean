...
\ifdefined\DISSERTATION
    \subsubsection{Indirect \gls{acr-oc} Solution Procedure}
...
%%%%%%%%%%%%%%%
\paragraph{Quartic Apparent \gls{acr-pwr} Constraints}
...
\gls{acr-nl} dynamics can reintroduce non-convexity and should be checked on a case-by-case basis.
...
%%%%%%%%%%%%%%%
\paragraph{Comparison to Other \gls{acr-wec} Constrained \gls{acr-ctl} Formulations}
...
%%%%%%%%%%%%%%%
\paragraph{Average \gls{acr-pwr} as a Function of Constraint Limits}
