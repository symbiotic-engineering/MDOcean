...
Constraints on the effort and flow magnitude (e.g., force limits $|\hat{F} |\leq \gls{sym-F-max}$) can be convex or non-convex, depending on the complex angle of the Th\'{e}venin equivalent of the relevant source impedance and on the ratio of the constraint limit to its unconstrained value.
