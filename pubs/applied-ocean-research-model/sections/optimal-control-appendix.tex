...
and $\gls{sym-c-mu} = \gls{sym-d-mu}|\gls{sym-Gamma-c-mu}|^2 - \gls{sym-vec-x-p}^{\,*}\gls{sym-mathbf-Q-mu}\gls{sym-vec-x-p} - 2\Re\!\left\{\gls{sym-vec-a-mu-2}^{\,*}\gls{sym-vec-x-p}\right\}$,
...
\begin{equation}\label{eq:gamma-opt-summary}
    ...
    & \text{none active} \\
        |\gls{sym-Gamma-c-mu}|^2
        - 2|\gls{sym-Gamma-c-mu}|\sqrt{\frac{\gls{sym-b-mu-star}+\gls{sym-c-mu-2}}{\gls{sym-d-mu-2}}}
        + \frac{\gls{sym-b-mu-star}+\gls{sym-c-mu-2}}{\gls{sym-d-mu-2}}
    & \text{only $\gls{sym-mu}^*$ active} \\
        \left|
            \Gamma_{c,\mu^*} + \frac{\Gamma_{c,\nu^*} - \Gamma_{c,\mu^*}}{d_{\mu^*\nu^*}}
            \left(                \gls{sym-a-mu-nu-star}
                \pm
                1i \sqrt{\frac{\gls{sym-b-mu-star} + \gls{sym-c-mu-2}}{\gls{sym-d-mu-2}}-\gls{sym-a-mu-nu-star}^2}
            \right)
        \right|^2
