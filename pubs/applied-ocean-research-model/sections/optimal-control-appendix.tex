...
\gls{sym-mathcal-C-cl} &= \left\{
    (|\gls{sym-Gamma-c-mu-2}| - \gls{sym-r-mu})e^{i\angle\,\gls{sym-Gamma-c-mu-2}}, \quad \forall \gls{sym-mu}
\right\}.
\end{aligned}
\end{equation}
...
\begin{aligned}
   \gls{sym-lambda-mu}
    ...
    \frac{\partial \gls{sym-p-avg-VI-opt}}{\partial |\gls{sym-Gamma-opt}|}
    \left(
        \frac{\partial |\gls{sym-Gamma-opt}|}{\partial \gls{sym-r-mu}}
...
\\
    &\left.
        \left(
            \textrm{quad}(\gls{sym-b-mu}, \gls{sym-b-nu}) +
