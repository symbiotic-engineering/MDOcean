...
\begin{tabular}{lccc}
    ...
    $|\gls{sym-hat-xi-f}| \leq \gls{sym-X-f-max}$ &
        $\frac{1}{\gls{sym-omega}^2}
        [\gls{sym-mathbf-a}_{(\gls{sym-F-p}\gls{sym-dot-xi})_f\leftarrow VI}]^*
        \gls{sym-mathbf-A}_{|\gls{sym-hat-q}|^2}
        [\gls{sym-mathbf-a}_{(\gls{sym-F-p}\gls{sym-dot-xi})_f\leftarrow VI}]$ &
        $[0,~ \gls{sym-hat-xi-f-0}]^\top$ & $\gls{sym-X-f-max} - |\gls{sym-hat-xi-f-0}|$ \\
    $|\gls{sym-hat-xi-s}| \leq \gls{sym-X-s-max}$ &
        $\frac{1}{\gls{sym-omega}^2}
        [\gls{sym-mathbf-a}_{(\gls{sym-F-p}\gls{sym-dot-xi})_s\leftarrow VI}]^*
        \gls{sym-mathbf-A}_{|\gls{sym-hat-q}|^2}
        [\gls{sym-mathbf-a}_{(\gls{sym-F-p}\gls{sym-dot-xi})_s\leftarrow VI}]$ &
        $[0,~ \gls{sym-hat-xi-s-0}]^\top$ & $\gls{sym-X-s-max} - |\gls{sym-hat-xi-s-0}|$ \\
