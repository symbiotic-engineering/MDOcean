...
\begin{figure}[h!]
    ...
    \begin{subfigure}[t]{0.32\textwidth}
        \includegraphics[width=\textwidth]{figs/from-matlab/drag_damping_integral.pdf}
        \caption{Drag damping integral $I_B$, scaled by $\frac{2}{\pi}$.}
        \label{fig:drag-damping-integral}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.32\textwidth}
        \includegraphics[width=\textwidth]{figs/from-matlab/drag_exc_mag_integral.pdf}
        \caption{Magnitude of drag excitation integral $|I_G|$, scaled by $\frac{2}{\pi}$.}
        \label{fig:drag-excitation-magnitude-integral}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.32\textwidth}
        \includegraphics[width=\textwidth]{figs/from-matlab/drag_exc_phase_integral.pdf}
...
\begin{aligned}
    ...
    \qquad
    \lim_{r\rightarrow 0} I_G(r,\theta,\kappa) = \frac{\pi J_1(\kappa)}{\kappa} \\
...
Instead, when $r\rightarrow \infty$, we apply an alternative convention that replaces the WEC speed in \cref{eq:drag-integrals-IB-IG} with the incident wave speed and uses a primed form of the integrals:
\begin{equation}
\begin{aligned}
...
\begin{equation}
 \left|
    \frac{\partial g\left(\vec{\hat{\dot{\xi}}}~\right)}
    {\partial \vec{\hat{\dot{\xi}}}}
\right| < 1
\end{equation}
