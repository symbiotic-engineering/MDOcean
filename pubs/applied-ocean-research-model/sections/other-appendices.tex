...
Assuming a drivetrain consisting of a linear to rotational gear ratio with equivalent radius $\gls{sym-R}$ followed by a driveshaft with impedance $\gls{sym-Z-shaft}$, the PTO mechanical dynamics are expressed with cascade matrix $[\gls{sym-mathbf-a}]_{F\gls{sym-dot-X}\leftarrow \gls{sym-tau} \gls{sym-Omega}}$:
