...
\citet{penalba_review_2016} review \gls{acr-wec} \gls{acr-pto} models and \citet{coe_co-design_2025} synthesize these into a multiport impedance matching network framework to facilitate control co-design.
...
%%%%%%%%%%%%%%%
\subsubsection{Combining Intrinsic \gls{acr-dyn} with \gls{acr-pto} Kinematics}
...
%%%%%%%%%%%%%%%
\subsubsection{\gls{acr-pto} \gls{acr-dyn}}
...
\subsubsection{Time-Domain Expansion of Instantaneous \gls{acr-pwr}}
...
%%%%%%%%%%%%%%%
\subsubsection{Electrical-Port \gls{acr-pwr} in Optimal-\gls{acr-ctl} Variables}
