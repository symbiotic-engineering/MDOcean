...
We show that under additional conditions (narrow-band wave input and a singular PTO DOF), the QCQP reduces to order 1 and can be solved semi-analytically using geometry.
