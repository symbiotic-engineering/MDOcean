...
Validation and computational benchmarking demonstrate that MDOcean's \resultsAOR[simRuntime] runtime outperforms leading WEC simulation software by orders of magnitude, while maintaining accuracy within a few percent of the baseline in most cases. 
...
\include{sections/model-intro}
\clearpage
\include{sections/model-overview}
\clearpage
\include{sections/module-details}
\clearpage
...
All modules integrate into a new open-source package called MDOcean, with a total simulation runtime of \results[simRuntime].
