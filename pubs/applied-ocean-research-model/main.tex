...
Validation and computational benchmarking demonstrate that MDOcean's \results[simRuntime] runtime outperforms leading WEC simulation software by orders of magnitude, while maintaining accuracy within a few percent of the baseline in most cases. 
...
%%Research highlights
\begin{highlights}
\item Develop and validate a rapid (\results[simRuntime]) open-source wave energy techno-economic simulation called MDOcean
