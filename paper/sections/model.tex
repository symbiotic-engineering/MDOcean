...
Solve \eqref{eq:eom-freq-domain} for $F_p$.}\\ 
 ...
 \parbox[m]{\linewidth}{\centering Maximum allowable float amplitude, $|X_f|_{max}$ }& $\min(X_{linear}, X_{slam})$& N/A %$X_{slam}$\\
    \end{tabular}
...
\hl{(Note: ideally it would use hydro coefficients for the unified float-spar geometry).}
