function [F_heave, F_surge, m, D_env] = hydro(t, s, m_float, D_sft, D_i,D_or,t_r,d_WEC, N_WEC, d_farm, d_shore, rho_w, g, Hs, T, t_f)
...
F_surge = 2 * (Hs/2) * rho_w * g * (vol_sf+vol_vc+vol_rp) * (1 - exp(-k*(draft_sf+draft_vc+draft_rp)));
