function [obj, grad] = generatedObjectiveP_var(inputVariables, extraParams)
% GENERATEDOBJECTIVEP_VAR Compute objective function value.
% 
% This function computes the objective value.
% Update the generated code to add the objective gradient computation.
% 
% OBJ = generatedObjectiveP_var(INPUTVARIABLES, EXTRAPARAMS) computes the
% objective value OBJ at the point INPUTVARIABLES, using the extra
% parameters in EXTRAPARAMS.
% 
% [OBJ, GRAD] = generatedObjectiveP_var(INPUTVARIABLES, EXTRAPARAMS)
% additionally computes the objective gradient value GRAD at the current
% point.
% 
% Auto-generated by prob2struct on 19-Nov-2021 04:33:29
% 
% 
