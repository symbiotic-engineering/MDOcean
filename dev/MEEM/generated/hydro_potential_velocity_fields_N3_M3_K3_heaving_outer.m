...
if (d2 < h)
    hydro_nondim_NMK = -t23.*t29.*t30.*(et1+et2);
elseif (h <= d2)
    hydro_nondim_NMK = t23.*t29.*t30.*(t2+t3+t4+t76+t83+t174+t182+t187+t191+t194+t201-(C_1m_2_const2.*t29.*t41.*t66.*(a1.*besselj(1,t134)-a2.*besselj(1,t136)).*1i)./besseli(0,t93)+(C_1m_2_const3.*t29.*t41.*t66.*(a1.*besselj(1,t135)-a2.*besselj(1,t138)).*5.0e-1i)./besseli(0,t100)-(C_1m_2_const4.*t29.*t41.*t66.*(a1.*besselj(1,t137)-a2.*besselj(1,t139)).*3.333333333333333e-1i)./besseli(0,t101));
else
