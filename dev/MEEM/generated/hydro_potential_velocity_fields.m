...
if (d2 < h)
    hydro_nondim_NMK = t31.*t32.*(t24.*(t78+t186+t210+(C_1n_1_const2.*a1.*t31.*t43.*t67.*besselj(1,t141).*1i)./besseli(0,t99)-(C_1n_1_const3.*a1.*t31.*t43.*t67.*besselj(1,t142).*5.0e-1i)./besseli(0,t105)+(C_1n_1_const4.*a1.*t31.*t43.*t67.*besselj(1,t144).*3.333333333333333e-1i)./besseli(0,t106))-t24.*(et1+et2));
elseif (h <= d2)
    hydro_nondim_NMK = t31.*t32.*(t24.*(t2+t3+t4+t80+t89+t188+t196+t201+t206+t211+t219-(C_1m_2_const2.*t31.*t43.*t68.*(a1.*besselj(1,t143)-a2.*besselj(1,t146)).*1i)./besseli(0,t100)+(C_1m_2_const3.*t31.*t43.*t68.*(a1.*besselj(1,t145)-a2.*besselj(1,t148)).*5.0e-1i)./besseli(0,t107)-(C_1m_2_const4.*t31.*t43.*t68.*(a1.*besselj(1,t147)-a2.*besselj(1,t149)).*3.333333333333333e-1i)./besseli(0,t108))+t24.*(t78+t186+t210+(C_1n_1_const2.*a1.*t31.*t43.*t67.*besselj(1,t141).*1i)./besseli(0,t99)-(C_1n_1_const3.*a1.*t31.*t43.*t67.*besselj(1,t142).*5.0e-1i)./besseli(0,t105)+(C_1n_1_const4.*a1.*t31.*t43.*t67.*besselj(1,t144).*3.333333333333333e-1i)./besseli(0,t106)));
else
