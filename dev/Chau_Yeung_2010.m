...
function [phi, force, A, B] = get_phi_force(eqns, unknowns_const, N, ...
    ...
    force = real(double(vpa(subs(force_2_over_rho_w_eiwt,{a2,d2,a1_over_a2},{a2_num,d2_num,a1_over_a2_num}))));
