...
'''
    ...
    try:
        ...
        docstring_count = content_after_second.count('%[DOCS AUTOGENERATED]')
...
def test_remove_duplicate_docstrings():
    ...
    duplicate_docstring = '''%[DOCS AUTOGENERATED]
...
'''
    ...
    try:
        ...
        markers = content_after_second.count('%[DOCS AUTOGENERATED]')
...
def test_remove_autogenerated_docstring_function():
    ...
    content_with_dup = '''%[DOCS AUTOGENERATED]
function out = test()
% Function test
%
% :param x: Some param
...
'''
    ...
    assert '%[DOCS AUTOGENERATED]' not in cleaned, "Still has autogenerated marker"
...
def test_has_docstring_with_autogenerated_marker():
    ...
    content_with_marker = '''%[DOCS AUTOGENERATED]
function out = test()
% Function test
% Old docstring
out = 42;
...
'''
    ...
    try:
        ...
        for run_num in range(1, 4):
            ...
            # Verify no duplicate markers
            marker_count = content.count('%[DOCS AUTOGENERATED]')
