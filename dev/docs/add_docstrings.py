...
def add_classdef_docstring(filepath, design_vars=None, param_descriptions=None):
    ...
    try:
        ...
        marker_line = "%[DOCS AUTOGENERATED]"
...
def has_docstring(content):
    ...
    for i, line in enumerate(lines):
        ...
        if stripped.startswith('function'):
            ...
            if i > 0 and '%[DOCS AUTOGENERATED]' in lines[i-1]:
...
def remove_autogenerated_docstring(content):
    ...
    while i < len(lines):
        ...
        # Skip all %[DOCS AUTOGENERATED] markers
        if '%[DOCS AUTOGENERATED]' in stripped:
            i += 1
            continue
...
def add_docstring_to_file(filepath, design_vars=None, param_descriptions=None):
    ...
    try:
        ...
        lines = content.split('\n')
        lines.insert(line_start_idx, '%[DOCS AUTOGENERATED]')
