...
[F_heave_max, F_surge_max, F_ptrain_max, ...
	    P_var, P_elec, P_matrix, h_s_extra, Kp_over_Ks] = dynamics(in, m_f_tot, m_s_tot, V_d, T);
...
g(11) = 1 + min(Kp_over_Ks,[],'all');   % spar heave stability (positive effective stiffness)
