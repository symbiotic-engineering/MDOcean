...
[F_heave_storm, F_surge_storm, ...
 ...
 P_matrix_mech,P_sat_ratio,power_lim_frac,...
...
[delta_CEM_CO2, CEM_wec_capacity, ...
 delta_CEM_grid_cost, margin_to_viability] = grid_CEM(B_p, X_u, phase_X_u, ...
...
net_eco_value = enviro(m_m, in.distance_from_shore, A_hull, ...
                        delta_CEM_CO2, CEM_wec_capacity, in.P_max, ...
...
if margin_to_viability ~= 0 % unviable or bad extrap
    J_grid = margin_to_viability;
else
    J_grid = delta_CEM_grid_cost / 1e9; % convert $ to $B
end
