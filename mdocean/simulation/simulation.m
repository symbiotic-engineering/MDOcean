...
[FOS_float,FOS_spar,FOS_damping_plate,...
    FOS_spar_local] = structures(...
            ...
            in.M, in.rho_w, in.g, in.sigma_y, in.sigma_e, in.E, in.nu, in.num_terms_plate);
...
g(13) = FOS_damping_plate(1) * in.FOS_mult_d / p.FOS_min - 1; % damping plate survives max force
g(14) = FOS_damping_plate(2) * in.FOS_mult_d / p.FOS_min - 1; % damping plate survives fatigue
