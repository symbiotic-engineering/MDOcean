...
g(24) = X_constraints(6);               % float slamming/submersion diameter
g(25) = X_constraints(7);               % spar slamming/submersion diameter
g(26:end) = X_constraints(8:end);       % prevent slamming/submersion (float+spar 
