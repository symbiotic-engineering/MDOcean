...
[V_d, m_m, m_f_tot, m_s_tot, ...
    ...
    I, T, V_f_pct, V_s_pct, GM, ~, A_dt, L_dt, t_d] = geometry(in.D_s, in.D_f,in.D_f_b, in.T_f_1, in.T_f_2, in.h_f, in.h_s, ...
...
[F_heave_max, F_surge_max, F_ptrain_max, ...
	    P_var, P_elec, P_matrix, h_s_extra] = ...
        dynamics(in, m_f_tot, m_s_tot, V_d, T);
