function [case_cell,case_desc_cell] = make_all_cases(runOnlyFewSeaStates)
    ...
    case_desc_cell  = {strcat('wecsim_wcsm_multi_true_', case_group_desc),...
                       strcat('wecsim_wcsm_multi_false_', case_group_desc),...
                       strcat('wecsim_rpt_multi_true_', case_group_desc),...
                      };
