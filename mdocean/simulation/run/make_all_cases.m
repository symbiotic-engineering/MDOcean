function [case_cell,case_desc_cell] = make_all_cases(runOnlyFewSeaStates)
    ...
    % Use short names to avoid exceeding 63-char MATLAB name limit:
    % wecsim_geom -> wg, multibody -> multi, singlebody -> singl
    case_desc_cell  = {strcat('wg_wcsm_multi_true_', case_group_desc),...
                       strcat('wg_wcsm_multi_false_', case_group_desc),...
                       strcat('wg_rpt_multi_true_', case_group_desc),...
                      };
