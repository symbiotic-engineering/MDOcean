...
% :param wecsim_filename: wecsim_filename
% :param report: report
% :param override: override
% :returns: weighted_power_error
% :returns: max_float_amp_error
% :returns: power_mech_err_matrix
% :returns: float_amp_err_matrix
...
function results = load_wecsim_results(wecsim_filename, p)
    ...
    vars = {'P','float_amplitude','spar_amplitude','relative_amplitude',...
        'force_pto','B_p','float_drag_force_rms','spar_drag_force_rms',...
        'float_drag_force_phase','spar_drag_force_phase'};
    ...
    [power_mech_unsat,...
     ...
     force_pto,...
     B_p,...
     float_drag_force_rms,...
     spar_drag_force_rms,...
     float_drag_force_phase,...
     spar_drag_force_phase] = deal(nan(sz));
    ...
    results = assemble_results_struct(size(power_mech_unsat),...
                                         ...
                                         'float_drag_force_rms',float_drag_force_rms,...
                                          'spar_drag_force_rms',spar_drag_force_rms,...
...
function results = assemble_results_struct(sz,varargin)
    ...
    var_names = {'power_mech_unsat', 'power_elec_unsat', 'power_elec_sat', ...
                 ...
                 'float_drag_force_rms','spar_drag_force_rms',...
                 'float_drag_force_phase','spar_drag_force_phase'};
