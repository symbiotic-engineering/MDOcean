...
function [errors_singlebody, errors_multibody, ...
            errors_report, table_out, fig_singlebody, fig_multibody] = validate_dynamics()
% Function validate_dynamics
%
% :returns: errors_singlebody
% :returns: errors_multibody
% :returns: errors_report
% :returns: table_out
% :returns: fig_singlebody
% :returns: fig_multibody
    ...
    table_out = [T_report;T_singlebody;T_multibody];
    table_out.Row = {'RM3 Report','WEC-Sim Singlebody','WEC-Sim Multibody'};
