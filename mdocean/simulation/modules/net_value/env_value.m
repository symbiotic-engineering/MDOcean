function [LVOE_matrix, LVOE_env] = env_value(force_matrix, P_elec, FCR, efficiency, years, avoided_co2_tons, scc_case)
...
[LVOE_matrix, LVOE_env] = LXOE_func(levelized_value_matrix, P_elec, efficiency);
