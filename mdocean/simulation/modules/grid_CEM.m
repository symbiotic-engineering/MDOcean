...
% :param B_p: B_p
% :param X_u: X_u
% :param phase_X_u: phase_X_u
% :param gamma_phase_f: $\\gamma$ phase f
% :param capacity_cost: capacity_cost
% :param location: location of grid data to use
% :returns: CEM_CO2
% :returns: CEM_wec_capacity
% :returns: CEM_grid_cost
