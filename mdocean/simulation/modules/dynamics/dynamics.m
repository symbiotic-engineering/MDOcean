...
function [F_heave_storm, F_surge_storm, ...
    ...
    qcqp_debug,ol_unstable] = dynamics(in,m_float,m_spar)
% Function dynamics
%
% :param in: in
...
% :returns: phase_X_u
    ...
    phase_F_drag_f,phase_F_drag_s,ol_unstable] = get_power_force(in,T,Hs,m_float,m_spar,...
...
function [P_matrix, X_constraints, B_p, K_p, ...
        ...
        F_drag_f, F_drag_s, phase_F_drag_f, ...
        phase_F_drag_s, ol_unstable] = get_power_force(in,T,Hs, m_float, m_spar, ...
    ...
    [mag_U,phase_U,...
     ...
     ol_unstable] = get_response_drag(H,w,k_wvn,m_f,m_s,m_c,B_h_f,B_h_s,B_c,K_h_f,K_h_s,...
