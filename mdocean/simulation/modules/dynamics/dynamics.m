function [F_heave_storm, F_surge_storm, F_heave_op, F_surge_op, F_ptrain_max, ...
    ...
    [~,X_constraints_storm,~,~,~,~,F_heave_storm,F_surge_storm,~,A_f_over_rho,...
        A_s_over_rho, A_c_over_rho, B_f_over_rho_w, B_s_over_rho_w, B_c_over_rho_w, ...
        gamma_f_over_rho_g, gamma_s_over_rho_g, gamma_phase_f, gamma_phase_s,w] = get_power_force(in, ...
...
% FIXME: check stability of closed loop multibody system
    ...
    fudge_factor = 1;%23.5 ./ (T.^2 - 14*T + 83) * in.power_scale;
