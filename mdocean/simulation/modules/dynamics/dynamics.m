function [F_heave_storm, F_surge_storm, ...
    ...
    gamma_phase_f,gamma_phase_s,w,phase_X_f,phase_X_u,F_heave_mat] = dynamics(in,m_float,m_spar)
    ...
    phase_X_f,phase_X_u,F_heave_mat] = get_power_force(in,T,Hs,m_float,m_spar,...
...
function [P_matrix, X_constraints, B_p, K_p, mag_U, mag_X_u, mag_X_f, mag_X_s,...
        ...
        B_f_over_rho_w, B_s_over_rho_w, B_c_over_rho_w, ...
        gamma_f_over_rho_g, gamma_s_over_rho_g, ...
        gamma_phase_f, gamma_phase_s,w,phase_X_f,phase_X_u,F_heave_mat] = get_power_force(in,T,Hs, m_float, m_spar, ...
