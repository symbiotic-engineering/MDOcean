...
function [F_heave_storm, F_surge_storm, ...
    ...
    F_drag_f,F_drag_s,phase_F_drag_f,phase_F_drag_s,...
    qcqp_debug] = dynamics(in,m_float,m_spar,compute_qcqp_debug)
% Function dynamics
%
% :param in: in
...
% :returns: phase_X_u
    ...
    if nargin < 4
        compute_qcqp_debug = false;
    end
    assert(islogical(compute_qcqp_debug) && isscalar(compute_qcqp_debug), ...
           'dynamics:InvalidComputeQcqpDebugFlag', ...
           'compute_qcqp_debug must be a logical scalar.');
...
function [P_matrix, X_constraints, B_p, K_p, ...
    ...
    [mag_U,phase_U,...
     ...
     qcqp_debug] = get_response_drag(H,w,k_wvn,m_f,m_s,m_c,B_h_f,B_h_s,B_c,K_h_f,K_h_s,...
