...
[sol1, sol2, sol3, sol4, sol5, sol6, sol7, sol8, sol9, sol10, sol11, sol12, ...
    sol13, sol14, sol15, sol16, sol17, sol18, sol19, sol20, sol21, sol22] ...
    = solve(eqn1, eqn2, eqn3, eqn4, eqn5, eqn6, eqn7, eqn8, eqn9, eqn10, ...
    eqn11, eqn12, eqn13, eqn14, eqn15, eqn16, eqn17, eqn18, eqn19, eqn20, eqn21)%, sigma_rr(1), sigma_rt(1), sigma_tt(1), sigma_tz(1), sigma_zr(1), sigma_zz(1), sigma_rr(2), sigma_rt(2), sigma_tt(2), sigma_tz(2), sigma_zr(2), sigma_zz(2), sigma_rr(3), sigma_rt(3), sigma_tt(3), sigma_tz(3), sigma_zr(3), sigma_zz(3), D_s, h_s, h_f, D_f)