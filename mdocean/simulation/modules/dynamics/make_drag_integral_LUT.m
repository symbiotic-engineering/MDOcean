...
% Function make_drag_integral_LUT
%
% :param rp_min: rp_min
% :param rp_step: rp_step
% :param rp_max: rp_max
% :param theta_step: $\\theta$ step
% :param kappa_step: $\\kappa$ step
% :param kappa_max: $\\kappa$ max
% :returns: drag_integral_fcn
