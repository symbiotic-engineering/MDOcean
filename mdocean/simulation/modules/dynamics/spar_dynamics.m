...
function [x_s_x_f_ratio] = spar_dynamics(Ds_over_Dd, D_d, rho_w, mu, C_d, T_s, ...
...
% todo: test spar equations, make figure of wamit results, latex equations, code equation for float drag
