...
function [control_evaluation_fcn,...
          real_G_u, imag_G_u] = linearize_around_guessed_response(X_f_guess, X_s_guess, ...
                                                                    ...
                                                                    gamma_s_lin_phase, multibody)
    % drag coefficients linearized around guess response
    [B_drag_f, gamma_drag_f] = get_drag_dynamic_coeffs(X_f_guess, phase_X_f_guess, mag_v0_f, w, drag_const_f);
    [B_drag_s, gamma_drag_s] = get_drag_dynamic_coeffs(X_s_guess, phase_X_s_guess, mag_v0_s, w, drag_const_s);
...
function [B_drag, gamma_drag] = get_drag_dynamic_coeffs(X_guess, phase_X_guess, mag_v0, w, drag_const)
