...
function [mag_U,phase_U,...
    ...
    [mag_U_unsat,phase_U_unsat,P_unsat,reactive_P_unsat,...
    ...
    if strcmpi(control_type,'none')
        ...
        mag_U = mag_U_unsat;
        phase_U = phase_U_unsat;
        real_P = P_unsat;
        reactive_P = reactive_P_unsat;
        mag_X_u = mag_X_u_unsat;
        phase_X_u = phase_X_u_unsat;
        mag_X_f = mag_X_f_unsat;
        phase_X_f = phase_X_f_unsat;
        mag_X_s = mag_X_s_unsat;
        phase_X_s = phase_X_s_unsat;
