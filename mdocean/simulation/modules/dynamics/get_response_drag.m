...
% :param K_h_f: K_h_f
% :param K_h_s: K_h_s
% :param gamma_f_mag: $\\gamma$ f mag
% :param gamma_f_phase: $\\gamma$ f phase
...
% :param F_lim_tol: max allowable iteration error on relative magnitude of force (-)
