...
function [mag_U,phase_U,...
    ...
    if strcmpi(control_type,'none')
        ...
        [~,~,~,~,~,~,~,...
         phase_U,reactive_P,...
         phase_X_u,phase_X_f,phase_X_s] = control_evaluation_fcn(K_p,B_p,stabilize_B,stabilize_K);
    else
...
function [mag_U,phase_U,real_P,reactive_P,...
        ...
        mag_X_s,phase_X_s,B_stabilized,K_stabilized,...
        constr_viol_err,...
        mag_ctrl_mult_stabilized,...
        phase_ctrl_mult_stabilized,optimality_err] = response_and_ctrl_err_from_ctrl_guess(...
                                                    ctrl_mult_guess,...
    ...
    [mag_U,real_P,...
     ...
     phase_U,reactive_P,...
     phase_X_u,phase_X_f,phase_X_s] = control_evaluation_fcn(K_p_sat,B_p_sat,stabilize_B,stabilize_K);
...
function [mag_U,real_P,...
     ...
     B_l,K_l,...
     phase_U,reactive_P,...
     phase_X_u,phase_X_f,phase_X_s] = evaluate_any_controller(...
                            B_c, B_f, B_s, K_f, K_s, ...
        ...
        if multibody
            if nargout > 7
                [mag_U,real_P,...
                 mag_X_u,mag_X_f,mag_X_s,...
                 phase_U,reactive_P,...
                 phase_X_u,phase_X_f,phase_X_s] = multibody_response(B_c, B_f, B_s, K_f, K_s, ...
                                                                      m_c, m_f, m_s, w, ...
                                                                      K_l, B_l, ...
                                                                      F_f_mag, F_f_phase, ...
                                                                      F_s_mag, F_s_phase, D_sys);
            else
                [mag_U,real_P,...
    ...
    if ~multibody || merge_bodies || nargout > 7
