function [mag_U,phase_U,...
    ...
    if max_drag_iters_fixed_point > 0
        [mag_U,phase_U,...
         ...
         F_drag_f,F_drag_s,...
         phase_F_drag_f,phase_F_drag_s,...
         ol_unstable] = fixed_point_iteration(X_f_guess,X_s_guess,...
    ...
    if max_drag_iters_solver > 0
        ...
        [mag_U,phase_U,...
         ...
         F_drag_f,F_drag_s,...
         phase_F_drag_f,phase_F_drag_s,...
         ol_unstable] = solver(X_f_guess,X_s_guess,...
                                        phase_X_f_guess,phase_X_s_guess,...
                                        ctrl_mult_guess,phase_ctrl_mult_guess,...
...
function [mag_U,phase_U,...
     ...
     F_drag_f,F_drag_s,...
     phase_F_drag_f,...
     phase_F_drag_s,ol_unstable] = solver(X_f_guess,X_s_guess,phase_X_f_guess,phase_X_s_guess,...
                                                ctrl_mult_guess,phase_ctrl_mult_guess,...
    ...
    [mag_U,phase_U,...
     ...
     phase_F_drag_f,...
     phase_F_drag_s,...
     ol_unstable] = dynamics_from_guess(X_f_solved, phase_X_f_solved, mag_v0_f, drag_const_f, ...
...
function [mag_U,phase_U,...
     ...
     phase_F_drag_f,...
     phase_F_drag_s,...
     ol_unstable] = fixed_point_iteration(X_f_guess,X_s_guess,phase_X_f_guess,phase_X_s_guess,...
                                                ctrl_mult_guess,phase_ctrl_mult_guess,...
                                                H,w,k_wvn,m_f,m_s,m_c,B_h_f,B_h_s,B_c,K_h_f,K_h_s,...
                                                gamma_f_mag,gamma_f_phase,gamma_s_mag,gamma_s_phase,...
                                                F_max,P_max,drag_const_f,drag_const_s,mag_v0_f,mag_v0_s,...
    ...
    while ~converged
        ...
        [X_f_err,X_s_err,...
         ...
         F_drag_f,F_drag_s,...
         phase_F_drag_f,phase_F_drag_s,...
         ol_unstable] = dynamics_error_wrapper(X_f_guess,X_s_guess,...
                                                       phase_X_f_guess,phase_X_s_guess,...
                                                       ctrl_mult_guess,phase_ctrl_mult_guess,...
                                                H,w,k_wvn,m_f,m_s,m_c,B_h_f,B_h_s,B_c,K_h_f,K_h_s,...
                                                gamma_f_mag,gamma_f_phase,gamma_s_mag,gamma_s_phase,F_max,P_max,...
...
function [X_f_err,X_s_err,...
    ...
    [mag_U,phase_U,...
     ...
     phase_F_drag_f,phase_F_drag_s,...
     force_lim_err,amp_lim_err,...
     ol_unstable] = dynamics_from_guess(X_f_guess, phase_X_f_guess, mag_v0_f, drag_const_f, ...
...
function [mag_U,phase_U,...
         ...
         amp_lim_err,...
         ctrl_mult_best,...
         phase_ctrl_mult_best, ol_unstable] = dynamics_from_guess(X_f_guess, phase_X_f_guess, mag_v0_f, drag_const_f, ...
                                         X_s_guess, phase_X_s_guess, mag_v0_s, drag_const_s, ...
                                         B_c,B_h_f,B_h_s,K_h_f,K_h_s,m_c,m_f,m_s,H,w,k_wvn,...
                                         gamma_f_mag,gamma_f_phase,gamma_s_mag,gamma_s_phase,...
                                         control_type,multibody,merge_bodies,F_max,P_max,X_max,...
...
function [mag_U,real_P,...
    ...
    [idx_closed_loop_unstable,...
     ...
     recommended_increase_Kl,...
     ol_unstable] = check_cl_stability(B_c, B_f, B_s, K_f, K_s, ...
                                                    m_c, m_f, m_s, w, ...
                                                    K_l, B_l, ...
                                                    idx_not_stabilizable, ...
                                                    multibody, merge_bodies);
    ...
    if nargout > 10 || ~multibody || merge_bodies
