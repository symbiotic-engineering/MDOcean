function [mag_U,phase_U,...
         ...
         B_p,K_p,P_sat_ratio,...
         F_drag_f,F_drag_s,...
    phase_F_drag_f,phase_F_drag_s] = get_response_drag(H,w,m_f,m_s,m_c,B_h_f,B_h_s,B_c,K_h_f,K_h_s,...
    ...
    % package inputs
    dynam_inputs = {H,w,m_f,m_s,m_c,B_h_f,B_h_s,B_c,K_h_f,K_h_s,...
                    gamma_f_mag,gamma_f_phase,gamma_s_mag,gamma_s_phase,F_max,...
                    drag_const_f,drag_const_s,mag_v0_f,mag_v0_s,...
                    X_max,control_type,multibody,...
                    X_tol,phase_X_tol,F_lim_tol,X_lim_tol,...
...
function [mag_U,phase_U,...
    ...
    fun_inner = @(x) dynamics_error_wrapper(unflatten(x,1),unflatten(x,2),...
                                    ...
                                    gamma_f_mag,gamma_f_phase,gamma_s_mag,gamma_s_phase,F_max,...
                                    drag_const_f,drag_const_s,mag_v0_f,mag_v0_s,...
                                    X_max,control_type,multibody,drag_fcn);
    ...
    [mag_U,phase_U,...
     ...
     phase_F_drag_s] = dynamics_from_guess(X_f_solved, phase_X_f_solved, mag_v0_f, drag_const_f, ...
                                    ...
                                    B_c,B_h_f,B_h_s,K_h_f,K_h_s,m_c,m_f,m_s,H,w,...
                                    gamma_f_mag,gamma_f_phase,gamma_s_mag,gamma_s_phase,...
                                    control_type,multibody,F_max,X_max,...
                                    ctrl_mult_solved,phase_ctrl_mult_solved,drag_fcn);
...
function [X_f_err,X_s_err,...
    ...
    [mag_U,phase_U,...
     ...
     phase_F_drag_f,phase_F_drag_s] = dynamics_from_guess(X_f_guess, phase_X_f_guess, mag_v0_f, drag_const_f, ...
                                    ...
                                    gamma_f_mag,gamma_f_phase,gamma_s_mag,gamma_s_phase,...
                                    control_type,multibody,F_max,X_max,...
                                    ctrl_mult_guess,phase_ctrl_mult_guess,drag_fcn); % closed loop dynamics
    % error
