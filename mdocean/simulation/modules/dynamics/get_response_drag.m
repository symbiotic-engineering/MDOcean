...
function [mag_U,phase_U,...
     ...
     phase_F_drag_f,...
     phase_F_drag_s,...
     ol_unstable] = solver(X_f_guess,X_s_guess,phase_X_f_guess,phase_X_s_guess,...
                                    ctrl_mult_guess,phase_ctrl_mult_guess,...
...
function [mag_U,phase_U,...
    ...
    [mag_U_unsat,~,P_unsat,...
     ~,~,~,mag_X_f_unsat,~,~,~,...
     B_p_stabilized,K_p_stabilized,ol_unstable] = control_evaluation_fcn(K_p,B_p,stabilize_B,stabilize_K);
...
function [mag_U,phase_U,...
     ...
     mag_X_s,phase_X_s,...
     B_l,K_l,...
     ol_unstable] = evaluate_any_controller(...
                            B_c, B_f, B_s, K_f, K_s, ...
