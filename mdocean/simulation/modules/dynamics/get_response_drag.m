...
function [mag_U,phase_U,...
    ...
    % Request phase_X_f/X_s (nargout=9) so they can be used as guesses during
    % the brute-force loop, avoiding per-controller phase recomputation there.
    [mag_U_unsat,P_unsat,...
     mag_X_u_unsat,...
     ...
     mag_X_s_unsat,...
     phase_X_f_unsat,...
     phase_X_s_unsat] = control_evaluation_fcn(K_p,B_p,stabilize_B,stabilize_K);
...
function [opt_mag_U,opt_phase_U,...
    ...
    [opt_mag_U, ~, opt_mag_X_u, opt_mag_X_f, opt_mag_X_s, ...
     opt_B_p_sat, opt_K_p_sat, opt_phase_X_f, opt_phase_X_s, ...
...
function [constr_viol_err,optimality_err] = control_errors_from_sat_results(ctrl_mult_mag,...
                                                   ...
                                                   X_f_upper_limit_static, mag_X_f_unsat, mag_X_f_guess, phase_X_f_guess,...
                                                   X_s_upper_limit_static, mag_X_s_unsat, mag_X_s_guess, phase_X_s_guess,...
                                                   X_u_upper_limit_static, mag_X_u_unsat,...
                                                   P_unsat, Z_th,...
                                                   H, k, D_f, D_d, T_f, T_s,...
                                                   mag_U, mag_X_u, B_p_sat, P_sat)

    % mag_X_f_guess/phase_X_f_guess (and _s_) may be the fully-computed saturated
    % response or the unsaturated-optimal guesses supplied by the brute-force loop
    % to avoid re-evaluating X_f/X_s for every controller candidate.
    mag_X_f   = mag_X_f_guess;
    phase_X_f = phase_X_f_guess;
    mag_X_s   = mag_X_s_guess;
    phase_X_s = phase_X_s_guess;
