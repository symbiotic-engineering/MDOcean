...
function stable = check_posdef_MB_strict_K_psd(a11,a12,a21,a22, b11,b12,b21,b22, c11,c12,c21,c22)
    % Like check_posdef_three_2x2s but accepts PSD (det >= 0) for the
    % third matrix (K). M and B still require strict PD (det > 0).
    % Rationale: with PD M and PD B, a PSD K (det=0) gives a BIBO-stable
    % system because the positive damping damps all modes, including any
    % zero-stiffness mode. Only a strictly negative K determinant indicates
    % true instability.
    stable = ...
            a11 > 0 & (a11.*a22 - a21.*a12) > 0 & ...
            b11 > 0 & (b11.*b22 - b21.*b12) > 0 & ...
