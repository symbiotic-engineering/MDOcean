function [mag_U,phase_U,...
    ...
    if max_drag_iters_solver > 0
        [mag_U,phase_U,...
         ...
         F_drag_f,F_drag_s,...
         phase_F_drag_f,phase_F_drag_s,...
         X_f_solved,phase_X_f_solved,...
         X_s_solved,phase_X_s_solved,...
         ctrl_mult_solved,phase_ctrl_mult_solved] = solver(X_f_guess,X_s_guess,...
                                        phase_X_f_guess,phase_X_s_guess,...
                                        ctrl_mult_guess,phase_ctrl_mult_guess,...
        ...
        if compute_qcqp_debug
            [mag_U,phase_U,...
             ...
             ~,~,...
             ~,~,...
             qcqp_debug] = dynamics_from_guess(X_f_solved, phase_X_f_solved, mag_v0_f, drag_const_f, ...
...
function [mag_U,phase_U,...
     ...
     X_f_solved,phase_X_f_solved,...
     X_s_solved,phase_X_s_solved,...
     ctrl_mult_solved,phase_ctrl_mult_solved] = solver(X_f_guess,X_s_guess,phase_X_f_guess,phase_X_s_guess,...
                                               ctrl_mult_guess,phase_ctrl_mult_guess,...
...
function [X_f_err,X_s_err,...
    ...
    [mag_U,phase_U,...
     ...
     force_lim_err,amp_lim_err] = dynamics_from_guess(X_f_guess, phase_X_f_guess, mag_v0_f, drag_const_f, ...
                                    ...
                                    drag_fcn, D_f, D_f_in, D_d, T_f_slam, T_s_slam, false, false); % closed loop dynamics; no polar plot or debug warnings during fsolve iterations
    % error
