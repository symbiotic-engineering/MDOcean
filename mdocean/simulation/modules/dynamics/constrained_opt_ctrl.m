function [mag_U,phase_U,...
         ...
         P_unsat,ol_unstable] = constrained_opt_ctrl(real_G_u, imag_G_u, w, control_type, ...
    ...
    [mag_U_unsat,P_unsat,...
     ...
     mag_X_f_unsat,mag_X_s_unsat,ol_unstable] = control_evaluation_fcn(K_p,B_p,stabilize_B,stabilize_K);
