...
function [mag_U,phase_U,...
         ...
         P_unsat] = constrained_opt_ctrl(real_G_u, imag_G_u, w, control_type, ...
                                          ...
                                          H, k_wvn, D_f, D_d)
% Function constrained_opt_ctrl
%
% :param real_G_u: real_G_u
% :param imag_G_u: imag_G_u
% :param w: Angular wave frequency (rad/s)
% :param control_type: reactive or damping
% :param control_evaluation_fcn: control_evaluation_fcn
...
% :param ctrl_mult_guess: ctrl_mult_guess
% :param phase_ctrl_mult_guess: phase_ctrl_mult_guess
% :param T_f_slam: T_f_slam
% :param T_s_slam: T_s_slam
% :param opt_ctrl_plot_debug_on: opt_ctrl_plot_debug_on
% :param B_h_f: B_h_f
% :param B_h_s: B_h_s
% :param B_c: B_c
% :param K_h_f: K_h_f
% :param K_h_s: K_h_s
% :param B_drag_f: B_drag_f
% :param B_drag_s: B_drag_s
% :param m_c: m_c
% :param m_f: m_f
% :param m_s: m_s
% :param multibody: multibody
% :param merge_bodies: merge_bodies
% :param X_f_guess: X_f_guess
% :param X_s_guess: X_s_guess
% :param phase_X_f_guess: phase_X_f_guess
% :param phase_X_s_guess: phase_X_s_guess
% :param H: H
% :param k_wvn: k_wvn
...
% :returns: K_p_sat
% :returns: qcqp_debug
% :returns: force_lim_err
% :returns: amp_lim_err
% :returns: ctrl_mult_best
% :returns: phase_ctrl_mult_best
% :returns: P_unsat
