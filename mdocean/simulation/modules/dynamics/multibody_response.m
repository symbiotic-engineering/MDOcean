%[DOCS AUTOGENERATED]
function [mag_U,real_P,mag_X_u,mag_X_f,mag_X_s,...
    phase_X_f,phase_X_s,phase_U,imag_P,phase_X_u] = multibody_response(B_c,B_f,B_s,K_f,K_s,...
...
if nargin == 33
    % Fast path: all 17 controller-independent helper terms are already set as
    % function arguments (t18, t9, t108, ...); only D_sys needs aliasing since
    % it already occupies arg 16 for the D_sys-only fast path.
    D_sys = h_D_sys;
else
...
t105 = t19+t21_plus_23+t62_plus_63;
t59 = -t32;
t70 = -t43;
t71 = -t44;
t72 = t32.*1i;
...
t101 = t100.^2;
t103 = t5+t41+t67+t95;
t106 = t6-t21_plus_23+t62_plus_63;
