...
function [V_d, m_m, m_f_tot, m_s_tot,...
         A_c, A_lat_sub, ...
         I, drafts, V_f_pct, V_s_pct, GM,...
         A_dt, L_dt, A_hull, mass,...
         CB_f_from_waterline,...
         CG_f_from_waterline,...
         CG_s_from_waterline] = geometry(D_s, D_f, D_f_in, D_f_b, ...
...
% :param D_f_b: D_f_b
% :param T_f_1: T_f_1
% :param T_f_2: Float Draft
% :param h_f: h_f
% :param h_s: Spar Height
% :param h_fs_clear: Float-Spar Clearance Height
% :param D_f_tu: float support tube diameter (m)
% :param t_f_t: t_f_t
% :param t_f_r: t_f_r
% :param t_f_c: t_f_c
% :param t_f_b: t_f_b
% :param t_f_tu: float support tube thickness (m)
% :param t_s_r: t_s_r
...
% :param theta_d_tu: angle from horizontal of damping plate support tubes (rad)
...
% :param rho_m: material density (kg/m3)
% :param rho_w: water density (kg/m3)
% :param m_scale: factor to account for mass of neglected stiffeners (-)
% :returns: V_d
% :returns: m_m
% :returns: m_f_tot
% :returns: m_s_tot
...
I = [I_f, I_vc, I_rp];
drafts = [T_f_2, T_s, h_d];          % drafts: used to calculated F_surge in dynamics.m
...
CG_s_keel = CGs(2:3) * mass(2:3)' / sum(mass(2:3));
CG_s_from_waterline = T_s - CG_s_keel;
