    ...
    methods
        ...
        function stages = write_calkit_stage(obj)
            ...
            analysis_stage = ['analysis-' class(obj) ':' newline ...
                              ...
                              '  command: add_mdocean_path(); cd("mdocean"); obj=' class(obj) '; obj.run_analysis();' newline ...
                              '  inputs: ' newline ...
            ...
            postpro_stage = ['postpro-' class(obj) ':' newline ...
                              '  kind: matlab-command' newline ...
                              '  environment: matlab' newline ...
                              '  command: add_mdocean_path(); cd("mdocean"); obj=' class(obj) '; obj.run_all_from_load();' newline ...
                              '  inputs: ' newline ...
