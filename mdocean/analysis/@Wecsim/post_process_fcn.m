...
% :returns: tab_colspecs
    ...
    end_result_struct.wecsimAvgPowerErrorBestCase = err_structs{1}.pct_error_baseline(1);
    end_result_struct.wecsimAvgPowerErrorWorstCase = err_structs{2}.pct_error_total(1);
end
