classdef Wecsim < GenericAnalysis
    ...
    methods
        function obj = Wecsim(varargin)
            ...
            % Use short names (multi = multibody, singl = singlebody) to comply with 63-char MATLAB name limit
            obj.extra_analysis_outputs = {'results/Wecsim/wecsim_sparcd0_floatcd0_multi_1_meem_off_geom_wecsim.mat', ...
                                 'results/Wecsim/wecsim_sparcd0_floatcd0_multi_0_meem_off_geom_wecsim.mat', ...
                                 'results/Wecsim/wecsim_sparcd0_floatcd0_multi_1_meem_10_geom_wecsim.mat', ...
                                 'results/Wecsim/wecsim_sparcd0_floatcd0_multi_0_meem_10_geom_wecsim.mat', ...
                                 'results/Wecsim/wecsim_sparcd1_floatcd1_multi_1_meem_off_geom_wecsim.mat', ...
                                 'results/Wecsim/wecsim_sparcd1_floatcd1_multi_0_meem_off_geom_wecsim.mat', ...
                                 'results/Wecsim/wecsim_sparcd1_floatcd1_multi_1_meem_10_geom_wecsim.mat', ...
                                 'results/Wecsim/wecsim_sparcd1_floatcd1_multi_0_meem_10_geom_wecsim.mat', ...
                                 'results/Wecsim/wecsim_sparcd0_floatcd0_multi_1_meem_off_geom_report.mat', ...
                                 'results/Wecsim/wecsim_sparcd0_floatcd0_multi_1_meem_10_geom_report.mat', ...
                                 'results/Wecsim/wecsim_sparcd1_floatcd1_multi_1_meem_off_geom_report.mat', ...
                                 'results/Wecsim/wecsim_sparcd1_floatcd1_multi_1_meem_10_geom_report.mat'};
        end
    end
...
function fig_names = fig_names_wrapper()
    ...
    if histogram_sep_figures
        ...
        case_names = extractAfter([case_desc_cell{:}],'wg_');
        ...
        for i = 1:num_groups % create separate plot names for each group
            case_names_i = extractAfter(case_desc_cell{i},'wg_');
