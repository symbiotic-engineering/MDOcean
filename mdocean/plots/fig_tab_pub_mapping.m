...
figs_in_AOR{6}  = 'ReadNonMatlabFigs.assumptions';
figs_in_AOR{7}  = 'ReadNonMatlabFigs.control_method_venn_diagram';
figs_in_AOR{8}  = 'ReadNonMatlabFigs.mod_freq_domain_ctrl_synthesis';
figs_in_AOR{9}  = 'ReadNonMatlabFigs.circuit_intrinsic';
figs_in_AOR{10}  = 'DescFcns.saturation_desc_fcn'; % subfig (a), combined with {50}
...
figs_in_AOR{17} = 'SweepGeoms.sweep_geoms_line'; % subfig (a), combined with {51}
figs_in_AOR{18} = 'SweepGeoms.sweep_geoms_pareto_nondim';
...
figs_in_AOR{23} = 'RunSingleFigFunc.nominal_power_matrix';
% appendix A - hydro
figs_in_AOR{24} = 'ReadNonMatlabFigs.meem_dims';
...
figs_in_AOR{30} = 'FitOlaya.case4_v1_auto_case2_overlay_loglog_khRxRpa2b_fv1';
% appendix B - dynamics (PTO kinematics, PTO circuit, QP, drag, slamming, WECSim)
figs_in_AOR{31} = 'ReadNonMatlabFigs.circuit_kinematics';
figs_in_AOR{32} = 'ReadNonMatlabFigs.circuit_pto';
figs_in_AOR{33} = 'QPCircles.qp_circles';
figs_in_AOR{34} = 'DragIntegral.drag_integral_B';     % subfig (a), combined with {52},{53}
figs_in_AOR{35} = 'Slamming.slamming_amplitude';
figs_in_AOR{36} = 'RunSingleFigFunc.slamming_model_comparison_float';
figs_in_AOR{37} = 'Wecsim.wecsim_wcsm_multi_drag_off_meem_off__power_mech_unsat'; % subfig, combined with {54},{55},{56}
figs_in_AOR{38} = 'Wecsim.wecsim_wcsm_multi_drag_on_meem_off__float_drag_force_fund'; % subfig, combined with {57},{58},{59}
figs_in_AOR{39} = 'Wecsim.position_THD_contour';
figs_in_AOR{40} = 'Wecsim.drag_force_desc_fcn';
figs_in_AOR{41} = 'Wecsim.wecsim_rpt_multi_drag_on_meem_on__power_mech_unsat';
...
figs_in_AOR{46} = 'DampingPlateStructures.damping_plate_moment';  % subfig (a), combined with {60}
% graphical abstract (unnumbered so at the end)
...
figs_in_AOR{48} = 'ReadNonMatlabFigs.mod_freq_domain_ctrl_evaluation'; % fig 9 subfig (b)
figs_in_AOR{49} = 'ReadNonMatlabFigs.mod_freq_domain_ctrl_combined'; % fig 9 subfig (c)
figs_in_AOR{50} = 'DescFcns.drag_desc_fcn';                         % fig 10 subfig (b)
figs_in_AOR{51} = 'SweepGeoms.sweep_geoms_line_cwr_sa';                 % fig 17 subfig (b)
...
figs_in_AOR{58} = 'Wecsim.wecsim_wcsm_multi_drag_on_meem_off__spar_drag_force_phase';  % fig 38 subfig
figs_in_AOR{59} = 'Wecsim.wecsim_wcsm_multi_drag_on_meem_off__float_drag_force_phase'; % fig 38 subfig
figs_in_AOR{60} = 'DampingPlateStructures.damping_plate_deflection'; % fig 46 subfig (b)
