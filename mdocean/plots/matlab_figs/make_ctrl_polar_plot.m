%[DOCS AUTOGENERATED]
function [fig, fig_gamma] = make_ctrl_polar_plot(MAG_GUESS, PHASE_GUESS, real_P, constraint_err, idx_opt, mag_ctrl_mult_stabilized, phase_ctrl_mult_stabilized)
...
% :returns: fig_gamma Polar gamma-space figure handle
    ...
    if have_stab
        ...
        MAG_STAB_flat   = reshape(mag_ctrl_mult_stabilized,   n_ss, n_stab);
        PHASE_STAB_flat = reshape(phase_ctrl_mult_stabilized, n_ss, n_stab);
        ...
        if any(is_shifted(:))
            ...
            p_stab_vals = P_ss(is_shifted);   % power already at stabilized controller
