...
T = [T;
    ...
    ...
    ...% Economics
    table("m_scale","m_{scale}",{1.05},"economics",false,...
    ...
    table("cost_perN", "$/N",{0.02*0.1656},"economics",true,...
        "cost per Newton ($/N), 0.1656 from https://doi.org/10.1016/j.ifacol.2022.10.531");
