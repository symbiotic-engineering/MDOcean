...
T = [T;
    ...
    table("cost_m","cost_m",{[4.28, 125/yd2m^3/2400, 1.84/lb2kg]},"economics",true,"material cost ($/kg)",{1});
...
...%         "damping plate support tube radial wall thickness (m)",{''});
    ...
    table("h_stiff_d","h_{stiff,d}",{[12.5 .5 22  1]*in2m},"structures",true,"damping plate stiffener height (m)",{'max'});
    table("w_stiff_d","w_{stiff,d}",{[.5 10 1 12]  * in2m},"structures",true,"damping plate stiffener width (m)",{'max'});
