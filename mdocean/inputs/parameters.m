...
T = [T;
    ...
    table("operational_drag_convergence_plot_on","operational_drag_convergence_plot_on",...
        {false},"dynamics",false,"whether to plot drag convergence (boolean)",{''});
    ...
    ...
    table("max_drag_iters_fxp","max drag iters fixed point",{30},"dynamics",false,... 
