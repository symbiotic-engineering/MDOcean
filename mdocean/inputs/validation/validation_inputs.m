...
RM3_report = struct(...
                ...
                'capex_struct', [2.94 20.67 91.55 177.93] ./ [1 10 50 100], ...
                ...                         % CBS (Total), row 24
                'capex_PTO',    [0.62 4.94 21.68 41.28] ./ [1 10 50 100],...
                ...                         % CBS (Total), row 29
...
RM3_wecsim = struct(...
                ...
                'capex_design', NaN(1,4), ... % fixme this shouldn't be needed here since it just comes from MDOcean
