...
function [ratios, LCOE, LCOE_nom, P_var, P_var_nom, ...
             ...
             runtime_post_optim, runtime_re_optim, num_reoptims] = param_sweep(filename_uuid)
...
% :returns: runtime_re_optim
    ...
    % Number of re-optimizations = params * (num non-nominal ratios)
    num_reoptims = length(params) * sum(ratios ~= 1);
