...
function [Xs_opt, objs_opt, flags, probs, ...
          lambdas, grads, hesses, vals, fmincon_outputs] = gradient_optim(x0_input,p,b,which_objs,plotfn,disp_on)
...
for matl = 1%1:2:3 %b.M_min : b.M_max
    ...
    lambdas, grads, hesses, vals, fmincon_outputs] = optimize_both_objectives(X,p,b,x0_input,opts,disp_on,which_objs,matl);
