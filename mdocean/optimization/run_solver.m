function [X_opt,obj_opt,flag,output,lambda,grad,hess,problem] = run_solver(prob, obj, x0, opts)
    ...
    if solver_based
        ...
        X_opt = [X_opt(2); X_opt(3); X_opt(6); X_opt(5); ...
            X_opt(4); X_opt(1); X_opt(14); X_opt(12); X_opt(11); X_opt(10); X_opt(9); X_opt(13); X_opt(8); X_opt(7)]; % reorder elements based on order in autogenerated objective files
