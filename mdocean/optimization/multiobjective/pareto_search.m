%[DOCS AUTOGENERATED]
function [x,fval,residuals,tol,p,...
          paretoPctTimeSeeds,paretoPctTimePatternSearch,...
          paretoTotalRuntime,paretoFcnEvals,...
          timeEpsConstraint,timeGradientFree,output] = pareto_search(p,b,filename_uuid,num_seeds_vector)
% Function pareto_search
%
% :param p: Parameter struct
% :param b: Design variable bounds struct
% :param filename_uuid: filename_uuid
% :returns: Design variable vector
% :returns: fval
% :returns: residuals
% :returns: tol
% :returns: Parameter struct
    ...
    paretoPctTimeSeeds = timeEpsConstraint / (timeEpsConstraint + timePatternSearch);
    paretoPctTimePatternSearch = timePatternSearch / (timeEpsConstraint + timePatternSearch);
    paretoTotalRuntime = timeEpsConstraint + timePatternSearch;
    paretoFcnEvals = output.funccount;
