...
[X_opt,val,flag,num_occurrences_max_pwr] = max_pwr_then_min_cost(p, b, x0_vec)
...
function [X_opt_2,val_2,flag_2,num_occurrences_max_pwr] = max_pwr_then_min_cost(p, b, x0_vec)
